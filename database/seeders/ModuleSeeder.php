...
class ModuleSeeder extends Seeder
{
    ...
    private function getAppsData(): array
    {
        return [
            ...
            [
                'title' => 'Bill Payments',
                'route' => '/dashboard?app=bill-payments',
                'icon' => 'RxCardStack',
                'visible' => false,
            ...
            [
                'title' => 'Jobs',
                'route' => '/dashboard?app=jobs',
                'visible' => false,
                'description' => 'Create and manage job boards, post jobs, and track applications from applicants. Complete recruitment management system.',
                'price' => 149,
                'categories' => ['HR', 'Recruitment', 'Business'],
                'comingSoon' => false,
                'pricingType' => 'subscription',
                'bgColor' => 'bg-emerald-100 dark:bg-emerald-900/30',
                'icon' => 'FaUsers',
