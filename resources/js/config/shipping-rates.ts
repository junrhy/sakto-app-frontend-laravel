...
export const findShippingRate = (
    ...
    let rate = PHILIPPINE_SHIPPING_RATES.find(
        (rate) =>
    ...
    if (!rate) {
        rate = PHILIPPINE_SHIPPING_RATES.find(
        ...
        return [
            {
                ...
                price: calculateWeightAdjustedRate(
                    baseStandardRate,
                    totalWeight,
                ),
            },
...
export const getBaseShippingMethods = (
    country: string,
    province: string,
    city: string,
): ShippingMethod[] => {
