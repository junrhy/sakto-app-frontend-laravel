        ...
        <div className="space-y-6">
                ...
                <div className="flex-1">
                    ...
                    {selectedVariant && (
                        <div className="flex items-center gap-2 mt-2">
                            ...
                            <span className="text-sm text-green-700 font-medium">{getStockStatus()}</span>
                        </div>
                    )}
                </div>
            </div>
            ...
            {Object.keys(availableAttributes).length > 0 && (
                <div className="space-y-6">
                    <div className="text-center">
                        <h4 className="text-lg font-semibold text-gray-900 mb-2">Choose Your Options</h4>
                        <p className="text-sm text-gray-600">Select your preferred options below</p>
                    </div>
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`
                                                ...
                                                ${!isAvailable ? 'opacity-50 cursor-not-allowed bg-gray-100' : 'cursor-pointer'}
                                        ...
                                        >
                                            ...
                                            {attributeKey.toLowerCase() === 'color' && (
                                                <div 
                                                    className="w-6 h-6 rounded-full border-2 border-white shadow-sm mx-auto mb-2"
                                                    style={{ 
                    ...
                    <div className="space-y-2">
                        <div className="flex items-center gap-2 flex-wrap">
                            {Object.entries(selectedVariant.attributes).map(([key, value]) => (
                                <Badge key={key} variant="secondary" className="bg-white text-green-800 border-green-300">
            ...
            <div className="space-y-3">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="w-16 h-10 flex items-center justify-center border border-gray-300 rounded-md bg-white font-semibold">
                        {quantity}
                    </div>
                    <Button
                        variant="outline"
