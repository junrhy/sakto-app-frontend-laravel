...
import { DollarSign, Users, AlertCircle, CheckCircle2, Clock } from "lucide-react";
...
interface Loan {
    ...
    installment_frequency?: 'weekly' | 'bi-weekly' | 'monthly' | 'quarterly' | 'annually';
        ...
        <div className="p-6 bg-white rounded-lg shadow-sm">
                ...
                <Card>
                    <CardContent className="p-4">
                        <div className="flex items-center justify-between">
                            ...
                            <span className="text-sm font-medium">{overdueBills}</span>
                        </div>
                    </CardContent>
                </Card>
            </div>
            ...
            <ScrollArea className="h-[calc(100%-20rem)]">
                <div className="space-y-4">
                    {bills.map((bill) => (
                        <Card key={bill.id} className={bill.status === 'overdue' ? 'bg-red-50 dark:bg-red-900/20' : ''}>
                            <CardContent className="p-4">
                                    ...
                                    <div className="flex-grow min-w-0">
                                        <div className="flex items-center justify-between">
                                            <span className="font-medium truncate">
                                                {loans.find(loan => loan.id === bill.loan_id)?.borrower_name}
                                            </span>
