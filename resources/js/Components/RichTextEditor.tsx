...
export default function RichTextEditor({
    ...
    return (
        <div className="rounded-lg border">
            ...
            <EditorContent
                editor={editor}
                className="prose prose-sm min-h-[200px] max-w-none p-4 focus:outline-none [&_.ProseMirror]:focus:border-0 [&_.ProseMirror]:focus:outline-none [&_.ProseMirror]:focus:ring-0"
            />
        </div>
    );
}
