...
export default function CircularFamilyTreeVisualization({
    ...
    useEffect(() => {
        ...
        const root = d3.hierarchy<HierarchyNode>(hierarchyData).sum(() => 1);
        ...
        const path = svg
            ...
            .on('click', (event: MouseEvent, d: ExtendedHierarchyNode) =>
                onNodeClick(d.data.member),
            );
        ...
        text.selectAll<SVGTSpanElement, ExtendedHierarchyNode>('tspan')
            ...
            .attr('dy', (_, i, nodes) => {
                const parentNode = d3
                    ...
                    >(nodes[i].parentNode as SVGElement)
                    .datum();
        ...
        path.on(
            'mouseover',
            function (event: MouseEvent, d: ExtendedHierarchyNode) {
        ...
        if (rootMember.id !== oldestAncestor.id && onBack) {
            ...
            backButton
                ...
                .attr(
                    'd',
                    `M${-radius * 0.06},${-radius * 0.05} L${-radius * 0.02},${-radius * 0.09} L${-radius * 0.02},${-radius * 0.07} L${radius * 0.06},${-radius * 0.07} L${radius * 0.06},${-radius * 0.03} L${-radius * 0.02},${-radius * 0.03} L${-radius * 0.02},${-radius * 0.01} Z`,
                )
