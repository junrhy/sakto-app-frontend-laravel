...
import { faCalendarAlt, faClock, faUser, faEnvelope, faPhone, faStethoscope, faUserMd } from '@fortawesome/free-solid-svg-icons';
...
const AppointmentBookingForm: React.FC<AppointmentBookingFormProps> = ({
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await router.post(route('medical.clinic.book-appointment', clinicId), formData as any, {
                onSuccess: () => {
                    onSuccess?.();
                },
                onError: (errors) => {
    ...
    return (
        <Card className="w-full max-w-2xl mx-auto bg-white border-gray-200 shadow-lg">
            <CardHeader className="bg-white border-b border-gray-100">
                ...
                <p className="text-gray-600">
                    Fill out the form below to schedule your appointment. We will contact you to confirm.
                </p>
            </CardHeader>
            <CardContent className="bg-white">
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="patient_email" className="text-sm font-medium text-gray-700">
                                Email Address *
                            </Label>
                            <Input
                                id="patient_email"
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="preferred_doctor" className="text-sm font-medium text-gray-700">
                    ...
                    {/* Submit Buttons */}
                    <div className="flex flex-col space-y-3 pt-4 md:flex-row md:space-y-0 md:space-x-3">
                        <Button
                            type="submit"
