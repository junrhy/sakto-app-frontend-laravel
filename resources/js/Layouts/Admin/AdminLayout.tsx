        ...
        <div className="flex flex-col h-full">
          ...
          <nav className="flex-1 px-4 py-4 space-y-2 overflow-y-auto">
            <div className="flex flex-col space-y-2">
              ...
              >
                <svg className={`w-5 h-5 mr-3 text-white transition-transform duration-200 ${route().current('admin.settings.index') ? 'scale-110' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className={`font-medium ${route().current('admin.settings.index') ? 'text-white' : 'text-white/80'}`}>Settings</span>
              </NavLink>
            </div>
          </nav>
