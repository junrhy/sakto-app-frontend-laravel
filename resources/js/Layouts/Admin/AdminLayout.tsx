        ...
        <div className="flex flex-col h-full">
          ...
          <nav className="flex-1 px-4 py-4 space-y-2 overflow-y-auto">
            <div className="flex flex-col space-y-2">
              ...
              >
                <svg className={`w-5 h-5 mr-3 text-white transition-transform duration-200 ${route().current('admin.apps.*') ? 'scale-110' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className={`font-medium ${route().current('admin.apps.*') ? 'text-white' : 'text-white/80'}`}>Apps</span>
              </NavLink>
