...
import { SparklesIcon, AlertCircle, Settings, ArrowLeft, CreditCard, History, Home, Wallet } from 'lucide-react';
...
export default function CreditsLayout({ children, header, user, auth: propAuth }: Props) {
            ...
            <div className="min-h-screen bg-white dark:bg-gray-800 relative">
                ...
                <div
                    className={
                        ...
                        ' fixed inset-y-0 left-0 w-64 transform transition-transform duration-300 ease-in-out sm:hidden bg-gradient-to-b from-green-900 to-green-800 shadow-lg z-[60] overflow-y-auto'
                    }
                >
                    <div className="space-y-1 pb-3 pt-2">
                        ...
                        <div className="border-t border-white/10">
                            <div className="px-4 py-2">
                                ...
                                <ResponsiveNavLink href={route('credits.buy')} className="text-white/80 hover:text-white hover:bg-white/10">
                                    <Wallet className="w-4 h-4 mr-2" />
                                    Buy Credits
                                </ResponsiveNavLink>
                                <ResponsiveNavLink href={route('credits.history', { clientIdentifier: authUser.identifier })} className="text-white/80 hover:text-white hover:bg-white/10">
                    ...
                    <div className="container mx-auto px-4 py-3">
                        <div className="flex items-center justify-between">
                            ...
                            <div className="hidden sm:flex sm:items-center sm:ml-6 space-x-4">
                                ...
                                <div className="ml-3 relative">
                                    <Dropdown>
                                        <Dropdown.Trigger>
                                            <button className="flex items-center text-sm font-medium text-gray-900 dark:text-white hover:text-green-900 hover:bg-white/10 focus:outline-none transition ease-in-out duration-150 rounded-md px-3 py-2">
                                                <div className="flex items-center">
                        ...
                        <div className="-mr-2 flex items-center sm:hidden">
                            <button
                                ...
                                className="inline-flex items-center justify-center p-2 rounded-md text-gray-900 dark:text-white hover:text-green-900 hover:bg-white/10 focus:outline-none focus:bg-white/10 focus:text-green-900 transition duration-150 ease-in-out"
                            >
