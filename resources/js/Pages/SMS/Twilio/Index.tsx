...
export default function Index({
    ...
    console.log('Account Selection Condition:', {
        hasActiveAccount,
        accountsLength: accounts.length,
        shouldShow: hasActiveAccount && accounts.length > 0,
    });
    ...
    const addRecipient = () => {
        ...
        if (!phoneRegex.test(newRecipient.trim())) {
            toast.error(
                'Please enter a valid phone number (e.g., +1234567890 or 09260049848)',
            );
            return;
        }
    ...
    const addSelectedContactsToRecipients = () => {
        ...
        toast.success(
            `${newRecipients.length} phone numbers added from contacts`,
        );
    };
                                ...
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm text-amber-700 dark:text-amber-300">
                                            You need to connect your Twilio
