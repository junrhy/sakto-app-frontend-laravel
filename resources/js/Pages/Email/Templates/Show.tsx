                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex space-x-3">
                                ...
                                <Link
                                    ...
                                    className="inline-flex items-center rounded-lg border border-transparent bg-gray-600 px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
                                >
                                    <svg
                                        className="mr-2 h-4 w-4"
                                        fill="none"
                    ...
                    <div className="space-y-6">
                                    ...
                                    <div className="mt-2 flex flex-wrap gap-2">
                                        {template.variables.map(
                                            (variable, index) => (
                                                <span
                                                    key={index}
                                                    className="inline-flex items-center rounded-md bg-gray-100 px-2.5 py-0.5 text-xs font-medium text-gray-800 dark:bg-gray-600 dark:text-gray-200"
                                                >
                                                    {`{{${variable}}}`}
                                                </span>
                                            ),
                        ...
                        <div className="overflow-hidden border border-gray-200 bg-white shadow-lg dark:border-gray-700 dark:bg-gray-800 sm:rounded-lg">
                            <div className="border-b border-gray-200 px-6 py-4 dark:border-gray-700">
                                ...
                                <p className="text-sm text-gray-600 dark:text-gray-400">
                                    The email body content with HTML formatting
                                </p>
                            </div>
                            <div className="p-6">
