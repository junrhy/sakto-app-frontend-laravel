...
export default function Index({ templates: initialTemplates, auth }: Props) {
    ...
    const handleToggleStatus = async (id: number, currentStatus: boolean) => {
        try {
            const response = await axios.patch(
                `/email/templates/${id}/toggle-status`,
            );
                        ...
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="mt-2 text-gray-600 dark:text-gray-400">
                                    Create and manage email templates for
                    ...
                    <div className="overflow-hidden border border-gray-200 bg-white shadow-lg dark:border-gray-700 dark:bg-gray-800 sm:rounded-lg">
                        <div className="border-b border-gray-200 px-6 py-4 dark:border-gray-700">
                            ...
                            <p className="text-sm text-gray-600 dark:text-gray-400">
                                Manage your email templates and their status
                            </p>
                        </div>
                                                ...
                                                <div className="flex justify-end space-x-3">
                                                    ...
                                                    {canDelete && (
                                                        <button
                                                            ...
                                                            className="inline-flex items-center text-red-600 hover:text-red-900 disabled:opacity-50 dark:text-red-400 dark:hover:text-red-300"
                                                        >
                                                            <svg
                                                                className="mr-1 h-4 w-4"
                                                                fill="none"
