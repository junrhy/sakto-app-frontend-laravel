...
export default function Applications({ auth, applications }: Props) {
    ...
    const filteredApplications = useMemo(() => {
        ...
        // Job filter
        if (jobFilter !== 'all') {
            result = result.filter((app) => app.job.id.toString() === jobFilter);
        }
            ...
            header={
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-4 md:grid-cols-7">
                        ...
                        <Card className="border-blue-200 bg-gradient-to-r from-blue-50 to-blue-100 dark:border-blue-800 dark:from-blue-900/20 dark:to-blue-800/20">
                            <CardContent className="p-4">
                                <p className="text-xs font-medium text-blue-600 dark:text-blue-400">Reviewed</p>
                                <p className="text-xl font-bold text-blue-900 dark:text-blue-100">{stats.reviewed}</p>
                            </CardContent>
                        </Card>
                        <Card className="border-purple-200 bg-gradient-to-r from-purple-50 to-purple-100 dark:border-purple-800 dark:from-purple-900/20 dark:to-purple-800/20">
                            <CardContent className="p-4">
                                <p className="text-xs font-medium text-purple-600 dark:text-purple-400">Shortlisted</p>
                                <p className="text-xl font-bold text-purple-900 dark:text-purple-100">{stats.shortlisted}</p>
                            </CardContent>
                        </Card>
                        <Card className="border-orange-200 bg-gradient-to-r from-orange-50 to-orange-100 dark:border-orange-800 dark:from-orange-900/20 dark:to-orange-800/20">
                            <CardContent className="p-4">
                                <p className="text-xs font-medium text-orange-600 dark:text-orange-400">Interviewed</p>
                                <p className="text-xl font-bold text-orange-900 dark:text-orange-100">{stats.interviewed}</p>
                            </CardContent>
                        </Card>
                        <Card className="border-green-200 bg-gradient-to-r from-green-50 to-green-100 dark:border-green-800 dark:from-green-900/20 dark:to-green-800/20">
                            <CardContent className="p-4">
                                <p className="text-xs font-medium text-green-600 dark:text-green-400">Accepted</p>
                                <p className="text-xl font-bold text-green-900 dark:text-green-100">{stats.accepted}</p>
                            </CardContent>
                        </Card>
                        <Card className="border-red-200 bg-gradient-to-r from-red-50 to-red-100 dark:border-red-800 dark:from-red-900/20 dark:to-red-800/20">
                            <CardContent className="p-4">
                                ...
                                <p className="text-xl font-bold text-red-900 dark:text-red-100">{stats.rejected}</p>
                            </CardContent>
                        </Card>
                    </div>
                </div>
                                ...
                                <Table>
                                    <TableHeader>
                                        <TableRow className="bg-gray-50 dark:bg-gray-700">
                                            <TableHead className="text-gray-900 dark:text-white">Applicant</TableHead>
