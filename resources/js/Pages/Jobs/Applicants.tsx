...
import { SearchIcon, UserPlus, Eye } from 'lucide-react';
...
export default function Applicants({ auth, applicants }: Props) {
    ...
    const handleDelete = (id: number) => {
        if (confirm('Are you sure you want to delete this applicant? This will also delete all their applications.')) {
                        ...
                        <Card>
                            <CardContent className="p-12 text-center">
                                ...
                                <h3 className="mt-4 text-lg font-semibold text-gray-900 dark:text-white">
                                    {search ? 'No applicants found' : 'No applicants yet'}
                                </h3>
                                ...
                                <Table>
                                    <TableHeader>
                                        <TableRow className="bg-gray-50 dark:bg-gray-700">
                                            ...
                                            <TableHead className="text-gray-900 dark:text-white">Applications</TableHead>
                                    ...
                                    <TableBody>
                                        {filteredApplicants.map((applicant) => (
                                            <TableRow key={applicant.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                                                ...
                                                <TableCell className="text-right text-gray-900 dark:text-white">
                                                    <Link href={route('jobs.applicant', applicant.id)}>
