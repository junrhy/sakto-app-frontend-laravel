...
interface LogisticsProps extends PageProps {
    logistics: LogisticsProvider[];
}

export default function Logistics({ auth, logistics }: LogisticsProps) {
    const [searchQuery, setSearchQuery] = useState('');

    // Filter logistics providers based on search query
