...
import { CommunityCurrency, HealthcareRecord } from '../types';

interface HealthcareRecordsSectionProps {
    id: string;
        ...
        <section id={id} className="space-y-4">
            <Card className="border border-gray-200 shadow-sm dark:border-gray-700 dark:bg-gray-800/80">
                <CardHeader>
                    ...
                    <CardDescription>
                        Matched using your membership information and contact details.
                    </CardDescription>
                </CardHeader>
                {items.length === 0 ? (
                    <CardContent className="flex flex-col items-center justify-center gap-3 rounded-lg border border-dashed border-gray-300 bg-gray-50/70 p-8 text-center text-gray-500 dark:border-gray-600 dark:bg-gray-900/40 dark:text-gray-400">
                        ...
                        <p className="text-xs">
                            We could not find any healthcare records that match your profile details.
                        </p>
                    </CardContent>
                ) : (
                                        ...
                                        >
                                            ...
                                            <TableCell className="text-gray-900 dark:text-white">
                                                <div className="flex items-center justify-between gap-2">
                                                    ...
                                                    <Link
                                                        href={route(
                                                            'customer.communities.healthcare.contributions',
                                                            {
                                                                community:
                                                                    communityIdentifier,
                                                                member: record.id,
                                            ...
                                            <TableCell className="text-gray-900 dark:text-white">
                                                <div className="flex items-center justify-between gap-2">
                                                    ...
                                                    <Link
                                                        href={route(
                                                            'customer.communities.healthcare.claims',
                                                            {
                                                                community:
                                                                    communityIdentifier,
                                                                member: record.id,
