...
interface MedicalProps extends PageProps {
    medical: MedicalProvider[];
}

export default function Medical({ auth, medical }: MedicalProps) {
    const [searchQuery, setSearchQuery] = useState('');

    // Filter medical providers based on search query
                    ...
                    <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        <div className="flex-shrink-0">
                            ...
                            <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                                Total: {filteredMedical.length}{' '}
                                {filteredMedical.length === 1
                                    ? 'provider'
                                    : 'providers'}
                            </p>
                        </div>
                        ...
                        <div className="rounded-lg border border-gray-200 bg-white p-6 text-center shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-8">
                            ...
                            <p className="mt-1 text-xs text-gray-500 dark:text-gray-400 sm:text-sm">
                                {searchQuery
                                    ...
                                    : 'No medical providers have been added yet.'}
                            </p>
                        </div>
                    )}
                </div>
