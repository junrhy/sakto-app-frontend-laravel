...
export default function MortuaryContributions({
    ...
    return (
        <CustomerLayout
            auth={auth}
            title={`Mortuary Contributions – ${memberName}`}
            header={
        ...
        >
            <Head title={`Mortuary Contributions – ${memberName}`} />
            ...
            <div className="space-y-6">
                ...
                <Card className="border border-gray-200 shadow-sm dark:border-gray-700 dark:bg-gray-800/80">
                    <CardHeader>
                        ...
                        <CardDescription>
                            Coverage profile used for mortuary contributions.
                        </CardDescription>
                    </CardHeader>
                ...
                <Card className="border border-gray-200 shadow-sm dark:border-gray-700 dark:bg-gray-800/80">
                    <CardHeader>
                        ...
                        <CardDescription>
                            Recorded mortuary contributions for {memberName}.
                        </CardDescription>
                    </CardHeader>
                    {hasContributions ? (
