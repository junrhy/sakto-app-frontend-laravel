...
interface FinanceProps extends PageProps {
    finance: FinanceProvider[];
}

export default function Finance({ auth, finance }: FinanceProps) {
    const [searchQuery, setSearchQuery] = useState('');

    const filteredFinance = finance.filter(
        (provider) =>
                        ...
                        <div className="rounded-lg border border-gray-200 bg-white p-6 text-center shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-8">
                            ...
                            <p className="mt-1 text-xs text-gray-500 dark:text-gray-400 sm:text-sm">
                                {searchQuery
                                    ...
                                    : 'No finance providers have been added yet.'}
                            </p>
                        </div>
                    )}
                </div>
