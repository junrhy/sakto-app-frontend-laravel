...
export default function VerifyEmail({ status }: { status?: string }) {
    ...
    return (
        <GuestLayout>
            <Head title="Customer Email Verification" />
                        ...
                        <div className="w-full max-w-[440px]">
                            <div className="mb-8">
                                ...
                                <p className="mt-4 text-base text-gray-600 dark:text-gray-400">
                                    Thanks for signing up as a customer! Before
                                    getting started, could you verify your email
                                    address by clicking on the link we just
                                    emailed to you? If you didn't receive the
                            ...
                            <form onSubmit={submit} className="space-y-6">
                                <div className="flex flex-col space-y-4">
                                    <PrimaryButton
                                        className="w-full justify-center rounded-lg bg-indigo-600 px-4 py-3 text-base font-medium hover:bg-indigo-700 focus:bg-indigo-700 active:bg-indigo-900 dark:bg-indigo-500 dark:hover:bg-indigo-600"
                                        disabled={processing}
                                    >
                                        {processing
                                            ? 'Sending...'
