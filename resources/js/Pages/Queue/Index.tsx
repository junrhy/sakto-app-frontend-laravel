...
import { Bell, CheckCircle, Clock, Plus, Users } from 'lucide-react';
...
export default function QueueIndex({ auth, queueTypes }: Props) {
    ...
    const getStatusCount = (status: string) => {
        return queueTypes.reduce((total, queueType) => {
            return (
                total +
                queueType.queue_numbers.reduce(
                    (count, qn) => count + (qn.status === status ? 1 : 0),
                    0,
                )
            );
        }, 0);
                                ...
                                <CardContent>
                                    <div className="space-y-4">
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            >
                                                {
                                                    queueType.queue_numbers.filter(
                                                        (qn) =>
                                                            qn.status ===
                                                            'waiting',
                                                    ).length
