...
export const CustomerDisplay: React.FC<CustomerDisplayProps> = ({
        ...
        try {
            ...
            if (response.ok) {
                ...
                if (
                    data.data &&
                    data.data.props &&
                    data.data.props.customerOrders
                ) {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 pb-6 pl-6">
            <div className="w-full">
                ...
                {/* Main Content Layout */}
                <div
                    className={`grid grid-cols-1 gap-6 ${videoUrl ? 'lg:grid-cols-2' : 'lg:grid-cols-1'}`}
                >
                    {/* Orders Section */}
                                ...
                                <div className="grid grid-cols-1 gap-3 xl:grid-cols-2">
                                    {customerOrders
                                        ...
                                        .map((order) => (
                                            <Card
                                                key={order.id}
                                                className="rounded-lg border-2 border-blue-300 bg-white transition-all hover:scale-105 hover:shadow-xl"
                                            >
                                ...
                                <div className="grid grid-cols-1 gap-3 xl:grid-cols-2">
                                    {customerOrders
                                        ...
                                        .map((order) => (
                                            <Card
                                                key={order.id}
                                                className="rounded-lg border-2 border-green-300 bg-white transition-all hover:scale-105 hover:shadow-xl"
                                            >
