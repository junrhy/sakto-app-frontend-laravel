...
import { Edit, History, Home, Plus, Search, Trash } from 'lucide-react';
...
export default function RentalProperty({
    ...
    const [isPaymentHistoryDialogOpen, setIsPaymentHistoryDialogOpen] =
        useState(false);
    const [selectedPropertyHistory, setSelectedPropertyHistory] =
        useState<RentalProperty | null>(null);
        ...
        try {
            if (currentProperty) {
                if (currentProperty.id) {
                    ...
                    await axios.put(
                        `/rental-property/${currentProperty.id}`,
                        currentProperty,
                    );
                } else {
                    // Add new property
    ...
    const handlePaymentSubmit = async (e: React.FormEvent) => {
        ...
        if (paymentProperty) {
            try {
                await axios.post(
                    `/rental-property/${paymentProperty.id}/payment`,
                    {
    ...
    const handlePaymentHistory = async (property: RentalProperty) => {
        try {
            const response = await axios.get(
                `/rental-property/${property.id}/payment-history`,
            );
                    ...
                    <CardContent>
                        <div className="mb-6 grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-6">
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    <div className="text-2xl font-bold">
                                        {analytics.propertiesInMaintenance}
                                    </div>
                                    <p className="text-xs text-muted-foreground">
                                        Properties
                                    </p>
                                ...
                                <div className="grid grid-cols-4 items-center gap-4">
                                    ...
                                    <Select
                                        ...
                                        onValueChange={(value) =>
                                            setCurrentProperty({
                                                ...currentProperty!,
                                                type: value as RentalProperty['type'],
                                            })
                                        }
                                    >
                                        ...
                                        <SelectContent>
                                            ...
                                            <SelectItem value="agricultural-lot">
                                                Agricultural Lot
                                            </SelectItem>
                                        </SelectContent>
                                    </Select>
                                    ...
                                    <>
                                        ...
                                        <div className="grid grid-cols-4 items-center gap-4">
                                            ...
                                            <Input
                                                ...
                                                type="date"
                                                value={
                                                    currentProperty?.last_payment_received ||
                                                    ''
                                                }
                                                onChange={(e) =>
                                                    setCurrentProperty({
                        ...
                        <div className="space-y-4">
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p className="text-sm">
                                        {selectedPropertyHistory?.address}
                                    </p>
                                </div>
                                <div>
                                    <Label>Tenant Name</Label>
                                    <p className="text-sm">
                                        {selectedPropertyHistory?.tenant_name}
                                    </p>
                                </div>
                                <div>
                                    <Label>Lease Period</Label>
                                    <p className="text-sm">
                                        {selectedPropertyHistory?.lease_start}{' '}
                                        to {selectedPropertyHistory?.lease_end}
                                    </p>
                                </div>
                                <div>
