        ...
        if (currentPayrollPeriod) {
            ...
            const formattedData = {
                ...
                start_date: currentPayrollPeriod.start_date
                    ? new Date(currentPayrollPeriod.start_date)
                          .toISOString()
                          .split('T')[0]
                    : '',
                end_date: currentPayrollPeriod.end_date
                    ? new Date(currentPayrollPeriod.end_date)
                          .toISOString()
                          .split('T')[0]
                    : '',
            };
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        ...
                        <Input
                            ...
                            onChange={(e) =>
                                handleChange('period_name', e.target.value)
                            }
                    ...
                    <DialogFooter>
                        ...
                        >
                            {currentPayrollPeriod ? 'Update' : 'Add'} Payroll
                            Period
                        </Button>
                    </DialogFooter>
                </form>
