...
import { SalaryHistory, Payroll } from '../types';
...
export const SalaryHistoryDialog = ({
    ...
    const handleChange = (field: keyof SalaryHistory, value: string | number) => {
        setFormData(prev => ({
            ...prev,
            [field]: value
        }));
            ...
            <DialogContent className="sm:max-w-[425px] bg-white dark:bg-gray-800">
                <DialogHeader>
                    <DialogTitle className="text-gray-900 dark:text-white">
                        {currentSalaryHistory ? 'Edit Salary History' : 'Add Salary History'}
                    </DialogTitle>
                </DialogHeader>
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            <Label htmlFor="effective_date" className="text-gray-700 dark:text-gray-300">
                                Effective Date
                            </Label>
                            <Input
                                id="effective_date"
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <Label htmlFor="previous_salary" className="text-gray-700 dark:text-gray-300">
                                Previous Salary
                            </Label>
                            <Input
                                id="previous_salary"
                                ...
                                onChange={(e) => handleChange('previous_salary', parseFloat(e.target.value) || 0)}
                                className="bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white"
                                required
                            />
                        </div>
                        <div>
                            <Label htmlFor="new_salary" className="text-gray-700 dark:text-gray-300">
                                New Salary
                            </Label>
                            <Input
                                id="new_salary"
                                ...
                                onChange={(e) => handleChange('new_salary', parseFloat(e.target.value) || 0)}
                                className="bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white"
                                required
                            />
                        </div>
                    ...
                    <div>
                        <Label htmlFor="change_reason" className="text-gray-700 dark:text-gray-300">
                            Change Reason
                        </Label>
                        <Input
                            id="change_reason"
                    ...
                    <div>
                        <Label htmlFor="approved_by" className="text-gray-700 dark:text-gray-300">
                            Approved By
                        </Label>
                        <Input
                            id="approved_by"
                    ...
                    <DialogFooter>
                        ...
                        >
                            {currentSalaryHistory ? 'Update' : 'Add'} Salary History
                        </Button>
                    </DialogFooter>
                </form>
            </DialogContent>
