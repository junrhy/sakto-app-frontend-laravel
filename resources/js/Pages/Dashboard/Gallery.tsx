...
export default function Gallery({ auth, dashboards, app }: Props) {
    ...
    const setAsDefault = (dashboardId: number) => {
        router.post(
            `/dashboard/${dashboardId}/set-default`,
            {},
            {
    ...
    const toggleStar = (dashboardId: number) => {
        router.post(
            `/dashboard/${dashboardId}/toggle-star`,
            {},
            {
                onSuccess: () => toast.success('Dashboard star status updated'),
                onError: () =>
                    toast.error('Failed to update dashboard star status'),
            },
        );
    };
                ...
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
                            ...
                            <DialogContent className="sm:max-w-[425px]">
                                ...
                                <div className="space-y-4 pt-4">
                                    ...
                                    <Button
                                        ...
                                        className="h-11 w-full text-base font-medium transition-all hover:scale-105"
                                    >
                                        Create Dashboard
                                    </Button>
                                </div>
                                    ...
                                    <CardHeader>
                                        <CardTitle className="flex items-center justify-between text-xl">
                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                >
                                                    <Star
                                                        className={`h-5 w-5 ${dashboard.is_starred ? 'fill-yellow-400 text-yellow-400' : 'text-gray-400'}`}
                                                    />
                                                </Button>
                                                {!dashboard.is_default && (
                                                    <Button
                    ...
                    {filteredDashboards.length === 0 && (
                        <motion.div
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: 1, y: 0 }}
                            className="rounded-lg bg-muted/30 py-16 text-center"
                        >
                            <Layout className="mx-auto mb-4 h-16 w-16 text-muted-foreground/50" />
                            <p className="text-lg text-gray-500 dark:text-gray-400">
                                {filters.starred &&
                                (filters.withWidgets || filters.withoutWidgets)
                        ...
                        <DialogContent>
                            <DialogHeader>
                                ...
                                <DialogDescription>
                                    ...
                                    {dashboardToDelete?.name}"? This action
