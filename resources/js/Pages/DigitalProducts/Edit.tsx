...
export default function Edit({ auth, product }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('digital-products.update', product.id));
    };
    ...
    return (
        <AuthenticatedLayout
            ...
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Edit Digital Product</h2>}
        >
            <Head title="Edit Digital Product" />

            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <Card>
                        <CardHeader>
                            <CardTitle>Edit Digital Product</CardTitle>
                        </CardHeader>
                        <CardContent>
