...
export type NewPatientAllergy = Omit<
    PatientAllergy,
    'id' | 'client_identifier' | 'created_at' | 'updated_at' | 'patient'
>;
export type NewPatientMedication = Omit<
    PatientMedication,
    'id' | 'client_identifier' | 'created_at' | 'updated_at' | 'patient'
>;
export type NewPatientMedicalHistory = Omit<
    PatientMedicalHistory,
    'id' | 'client_identifier' | 'created_at' | 'updated_at' | 'patient'
>;

// New comprehensive encounter type for creating new encounters
export type NewPatientEncounter = Omit<
    PatientEncounter,
    | 'id'
    | 'encounter_number'
    | 'created_at'
...
> & {
    ...
    // Optional encounter number (generated by backend if not provided)
    encounter_number?: string;
