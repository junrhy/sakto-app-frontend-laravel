        ...
        <div className="space-y-6">
            <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                    Complete the patient information below
                </p>
            </div>
                            ...
                            <CardContent className="space-y-4">
                                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                    <div>
                                        ...
                                        <Input
                                            ...
                                            value={
                                                newPatient.emergency_contact_name ||
                                                ''
                                            }
                                            onChange={(e) =>
                                                updateField(
                                    ...
                                    <div>
                                        ...
                                        <Select
                                            value={
                                                newPatient.emergency_contact_relationship ||
                                                ''
                                            }
                                            onValueChange={(value) =>
                                                updateField(
                                    ...
                                    <div>
                                        ...
                                        <Input
                                            ...
                                            value={
                                                newPatient.emergency_contact_phone ||
                                                ''
                                            }
                                            onChange={(e) =>
                                                updateField(
                                    ...
                                    <div>
                                        ...
                                        <Input
                                            ...
                                            type="email"
                                            value={
                                                newPatient.emergency_contact_email ||
                                                ''
                                            }
                                            onChange={(e) =>
                                                updateField(
                                ...
                                <div>
                                    ...
                                    <Textarea
                                        ...
                                        value={
                                            newPatient.emergency_contact_address ||
                                            ''
                                        }
                                        onChange={(e) =>
                                            updateField(
                                ...
                                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                                    ...
                                    <div>
                                        ...
                                        <Input
                                            ...
                                            value={
                                                newPatient.insurance_policy_number ||
                                                ''
                                            }
                                            onChange={(e) =>
                                                updateField(
                                    ...
                                    <div>
                                        ...
                                        <Input
                                            ...
                                            type="date"
                                            value={
                                                newPatient.insurance_expiration_date ||
                                                ''
                                            }
                                            onChange={(e) =>
                                                updateField(
