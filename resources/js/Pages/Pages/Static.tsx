...
const Static: React.FC<StaticProps> = ({ slug }) => {
    ...
    if (slug === 'bitaganfamily') {
        return (
            <>
                <Head>
                    <title>Bitagan Family</title>
                    <meta property="og:title" content="Bitagan Family" />
                    <meta property="og:description" content="Explore and manage your family connections" />
                    <meta property="og:type" content="website" />
                    <meta property="og:url" content={`${host}/static/${slug}`} />
                </Head>
