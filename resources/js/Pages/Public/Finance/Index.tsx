            ...
            <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-green-50">
                ...
                <div className="mb-16 mt-16 px-4 sm:px-6 lg:px-8">
                    <div className="mx-auto max-w-4xl">
                        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-amber-500 to-yellow-600 p-1 shadow-2xl">
                            <div className="rounded-xl bg-white p-8 md:p-12">
                                <div className="text-center">
                                    <div className="mb-4 inline-flex items-center rounded-full bg-amber-100 px-4 py-2 text-sm font-semibold text-amber-800">
                                    ...
                                    <h2 className="mb-4 text-3xl font-bold text-gray-900 md:text-4xl">
                                        Try Our Finance Platform Risk-Free
                                    </h2>
                                    ...
                                    <div className="mb-8">
                                        <div className="mb-2 text-5xl font-extrabold text-amber-600">
                                            {formatCurrency(
                                                starterPlan?.price || 0,
                                    ...
                                    {auth.user ? (
                                        <Link
                                            href={route('home')}
                                            className="inline-flex items-center justify-center rounded-lg bg-amber-600 px-8 py-4 text-lg font-semibold text-white shadow-lg transition-all duration-200 hover:bg-amber-700 hover:shadow-xl"
                                        >
                                            Go to My Account
                                        </Link>
                                    ) : (
                ...
                <div id="pricing" className="bg-white py-12 sm:py-16 lg:py-24">
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <div className="text-center">
                            ...
                            <p className="mt-3 text-base text-gray-600 sm:mt-4 sm:text-lg lg:text-xl">
                                After your free trial, choose the plan that fits your financial needs
                            </p>
                        </div>
