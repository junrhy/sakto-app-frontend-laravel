...
export default function TravelShow({
    ...
    const activeTheme =
        themeOptions[(themeParam ?? 'default').toLowerCase()] ??
    ...
    const formatCurrency = useMemo(() => {
        ...
        return (value: number) => {
            ...
            const withGrouping = whole.replace(
                /\B(?=(\d{3})+(?!\d))/g,
                thousands,
            );
    ...
    const journeyStats = useMemo(() => {
        ...
        const featuredCount = formattedPackages.filter(
            (pkg) => pkg.is_featured,
        ).length;
        ...
        return [
            ...
            },
            {
                ...
                value:
                    uniqueTypes.length > 0 ? `${uniqueTypes.length}` : 'Custom',
                description:
    ...
    const highlightPackages = useMemo(() => {
        const featured = formattedPackages
    ...
    const getPrimaryImage = (pkg: TravelPackage): string | null => {
        ...
        const firstValid = pkg.media.find(
            ...
            <main className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
                <div className="grid gap-6 lg:grid-cols-[2fr,1fr]">
                    <section className="space-y-6">
                        <div
                            className={cn(
                                'relative overflow-hidden rounded-3xl p-6 shadow-lg ring-1 sm:bg-white sm:p-10',
                        ...
                        >
                            <div
                                className={cn(
                                    'absolute -right-16 -top-16 hidden h-48 w-48 rounded-full blur-3xl sm:block',
                                    activeTheme.heroShapePrimary,
                                )}
                            />
                            <div
                                className={cn(
                                    'absolute bottom-0 left-0 hidden h-24 w-24 rounded-full blur-2xl sm:block',
                                    activeTheme.heroShapeSecondary,
                                )}
                            />
                            <div className="relative flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
                                <div className="max-w-2xl space-y-3 sm:space-y-4">
                                    ...
                                    <h2 className="text-2xl font-bold text-slate-900 sm:text-4xl">
                                        Discover journeys crafted around the way
                                        you like to travel
                                    </h2>
                                    <p className="text-sm text-slate-600 sm:text-base">
                                        Tailored escapes, reliable partners, and
                                        a dedicated concierge to handle the
                                    ...
                                    <div className="flex flex-wrap gap-3">
                                        ...
                                        >
                                            <a
                                                href={`mailto:${travel.email}?subject=Travel%20Package%20Inquiry`}
                                            >
                                ...
                                {heroImages.length > 0 ? (
                                    <div className="relative hidden w-full max-w-sm shrink-0 gap-4 md:flex md:flex-col">
                                        <div
                                            className={cn(
                                                'overflow-hidden rounded-3xl shadow-lg ring-1',
                                                activeTheme.cardRing,
                                            )}
                                        >
                                            <img
                                                ...
                                                {heroImages
                                                    ...
                                                    .map((image, index) => (
                                                        <div
                                                            ...
                                                            className={cn(
                                                                'overflow-hidden rounded-2xl shadow-md ring-1',
                                                                activeTheme.cardRing,
                                                            )}
                                                        >
                                                            <img
                                    ...
                                    >
                                        <div
                                            className={cn(
                                                ...
                                                activeTheme.iconBgSecondary,
                                                activeTheme.iconSecondaryText,
                                            )}
                                        >
                                        ...
                                        <p className="text-sm text-slate-600">
                                            Helping travellers design memorable
                                            journeys tailored to their pace and
                                            style.
                                        </p>
                                    </div>
                                )}
                            ...
                            <div
                                className={cn(
                                    'mt-6 rounded-2xl border bg-white p-4 text-sm text-slate-600 sm:hidden',
                                    activeTheme.accentCardBorder,
                                )}
                            >
                                Seamless planning, secured partners, and pricing
                                transparency—book a consultation to start
                                building your trip.
                            </div>
                            <div className="relative mt-8 hidden gap-4 sm:grid sm:grid-cols-3">
                                {journeyStats.map((stat) => (
                                    <div
                                        key={stat.label}
                                        className={cn(
                                            'rounded-2xl bg-white/80 p-4 shadow-sm ring-1 backdrop-blur',
                                            activeTheme.cardRing,
                                        )}
                                    >
                                ...
                                <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
                                    <div>
                                        ...
                                        <p className="mt-2 text-sm text-slate-600">
                                            Crafted for travellers seeking
                                            seamless coordination, authentic
                                            encounters, and remarkable stays.
                                        </p>
                                    </div>
                                </div>
                                    ...
                                    {highlightPackages.map((pkg) => {
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <div
                                                    className={cn(
                                                        'mt-5 flex items-center justify-between text-sm font-medium',
                                                        activeTheme.accentTagText,
                                                    )}
                                                >
                                                    <span>
                        ...
                        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                            <div>
                                ...
                                <p className="mt-1 text-sm text-slate-600">
                                    Choose from immersive experiences, premium
                                    getaways, or family-friendly tours.
                                </p>
                            </div>
                            <Badge
                                variant="outline"
                                className={cn(
                                    'w-fit',
                                    activeTheme.accentBadgeBorder,
                                    activeTheme.accentBadgeBg,
                                    activeTheme.accentBadgeText,
                                )}
                            >
                        ...
                        <div className="grid gap-6 md:grid-cols-2">
                            {hasPackages ? (
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div className="relative overflow-hidden bg-white p-6">
                                                ...
                                                <div
                                                    className={cn(
                                                        'relative mt-4 flex flex-wrap items-center gap-3 text-sm',
                                                        activeTheme.accentTagText,
                                                    )}
                                                >
                                                    <span
                                ...
                                <div className="col-span-full rounded-2xl border border-dashed border-slate-300 bg-white p-12 text-center">
                                    ...
                                    <p className="mt-2 text-sm text-slate-600">
                                        Check back soon to explore curated
                                        itineraries from {travel.name}.
                                    </p>
                                </div>
                            )}
                        </div>
                    ...
                    <aside className="space-y-6">
                        ...
                        >
                            ...
                            <CardContent className="space-y-4 text-sm text-slate-600">
                                ...
                                >
                                    Need a bespoke experience? Reach out to
                                    craft a personalised itinerary that fits
                                    your travel goals.
                                </div>
                                {travel.contact_number && (
                                    <Button
                        ...
                        >
                            ...
                            <CardContent className="space-y-4 text-sm text-slate-600">
                                ...
                                >
                                    ...
                                    >
                                        Each itinerary is designed with local
                                        insight, reliable partners, and top-tier
                                        accommodations.
                                    </p>
                                </div>
                ...
                <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
                    <div className="grid gap-8 lg:grid-cols-3">
                        <div className="space-y-3">
                            ...
                            <p className="text-sm text-slate-600">
                                Journey planning made effortless—{travel.name}{' '}
                                crafts tailored getaways backed by trusted local
                                partners and concierge support from day one.
                            </p>
                        ...
                        <div className="space-y-4">
                            ...
                            <p className="text-sm text-slate-600">
                                Ready to start planning? Tell us the experiences
                                you’re after and we’ll tailor the rest.
                            </p>
                            <div className="flex flex-col gap-3 sm:flex-row lg:flex-col">
                                ...
                                >
                                    <a
                                        href={`mailto:${travel.email}?subject=Plan%20my%20trip`}
                                    >
                                        Request an itinerary
                                    </a>
                                </Button>
                    ...
                    >
                        <p>
                            © {new Date().getFullYear()} {travel.name}. All
                            rights reserved.
                        </p>
                        <p className="text-center sm:text-right">
                            Seamless travel planning • Personalised experiences
