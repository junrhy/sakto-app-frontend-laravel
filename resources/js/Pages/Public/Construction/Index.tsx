            ...
            <div className="min-h-screen bg-gradient-to-br from-slate-50 via-gray-50 to-zinc-50">
                ...
                <div className="mb-16 mt-16 px-4 sm:px-6 lg:px-8">
                    <div className="mx-auto max-w-4xl">
                        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-orange-500 to-amber-600 p-1 shadow-2xl">
                            <div className="rounded-xl bg-white p-8 md:p-12">
                                <div className="text-center">
                                    ...
                                    <h2 className="mb-4 text-3xl font-bold text-gray-900 md:text-4xl">
                                        Try Our Construction Platform Risk-Free
                                    </h2>
                ...
                <div id="pricing" className="bg-white py-12 sm:py-16 lg:py-24">
                    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        <div className="text-center">
                            ...
                            <p className="mt-3 text-base text-gray-600 sm:mt-4 sm:text-lg lg:text-xl">
                                After your free trial, choose the plan that fits your project size
                            </p>
                        </div>
