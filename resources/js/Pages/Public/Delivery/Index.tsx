...
export default function DeliveryIndex({ auth }: PageProps) {
    ...
    const pricing = getPricingForService('delivery', currency, symbol);
            ...
            <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-pink-50">
                ...
                <div className="mb-16 mt-16 px-4 sm:px-6 lg:px-8">
                    <div className="mx-auto max-w-4xl">
                        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-orange-500 to-red-600 p-1 shadow-2xl">
                            <div className="rounded-xl bg-white p-8 md:p-12">
                                <div className="text-center">
                                    <div className="mb-4 inline-flex items-center rounded-full bg-orange-100 px-4 py-2 text-sm font-semibold text-orange-800">
                                    ...
                                    <h2 className="mb-4 text-3xl font-bold text-gray-900 md:text-4xl">
                                        Try Our Delivery Platform Risk-Free
                                    </h2>
                                    ...
                                    <div className="mb-8">
                                        <div className="mb-2 text-5xl font-extrabold text-orange-600">
                                            {formatCurrency(
                                                starterPlan?.price || 0,
                                    ...
                                    {auth.user ? (
                                        <Link
                                            href={route('home')}
                                            className="inline-flex items-center justify-center rounded-lg bg-orange-600 px-8 py-4 text-lg font-semibold text-white shadow-lg transition-all duration-200 hover:bg-orange-700 hover:shadow-xl"
                                        >
                                            Go to My Account
                                        </Link>
                                    ) : (
                ...
                <div id="pricing" className="mb-16 mt-16 px-4 sm:px-6 lg:px-8">
                    <div className="mb-12 text-center">
                        ...
                        <p className="mx-auto max-w-2xl text-lg text-slate-600">
                            After your free trial, select the perfect plan for your delivery needs. All
                        ...
                        <div className="group relative lg:-mt-4 lg:mb-4">
                            ...
                            <div className="relative flex h-full flex-col rounded-xl border-2 border-orange-500 bg-white p-8 shadow-lg">
                                ...
                                <div>
                                    ...
                                    {proPlan?.tagline && (
                                        <p className="mb-4 text-xs italic text-orange-600">
                                            {proPlan.tagline}
                                        </p>
                                    )}
                                    <p className="mb-6">
                            ...
                            <div className="relative flex h-full flex-col rounded-xl border border-slate-200 bg-white p-8 shadow-sm transition duration-200 hover:shadow-lg">
                                <div>
                                    ...
                                    {businessPlan?.tagline && (
                                        <p className="mb-4 text-xs italic text-red-600">
                                            {businessPlan.tagline}
                                        </p>
                                    )}
                                    <p className="mb-6">
