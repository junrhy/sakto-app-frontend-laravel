            ...
            <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
                ...
                <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
                    <Card className="border-0 bg-white/90 shadow-2xl backdrop-blur-sm dark:bg-gray-800/90">
                        <CardHeader className="border-b border-gray-200 bg-gradient-to-r from-indigo-50 to-purple-50 dark:border-gray-700 dark:from-indigo-900/20 dark:to-purple-900/20">
                            ...
                            <CardDescription className="mt-2 text-base text-gray-600 dark:text-gray-400">
                                ...
                                application. All fields marked with * are
                                required.
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="p-8">
                            <form onSubmit={handleSubmit} className="space-y-8">
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-center space-x-3 border-b border-gray-200 pb-4 dark:border-gray-700">
                                ...
                                <div className="space-y-6">
                                    <div className="flex items-center space-x-3 border-b border-gray-200 pb-4 dark:border-gray-700">
                                        <div className="h-1 w-8 rounded-full bg-gradient-to-r from-purple-500 to-pink-600"></div>
                                        <h3 className="text-xl font-bold text-gray-900 dark:text-white">
                                            Professional Information
                                        </h3>
                                    </div>
                                ...
                                <div className="flex items-center justify-end space-x-4 border-t border-gray-200 pt-6 dark:border-gray-700">
                                    ...
                                    <Button
                                        type="submit"
                                        disabled={processing}
                                        className="h-12 bg-gradient-to-r from-indigo-600 to-purple-600 px-8 font-semibold text-white shadow-lg transition-all duration-300 hover:from-indigo-700 hover:to-purple-700 hover:shadow-xl disabled:opacity-50"
                                    >
                                        {processing ? (
                                            <>
