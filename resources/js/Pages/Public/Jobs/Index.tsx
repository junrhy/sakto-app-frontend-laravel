...
export default function JobsIndex({ auth }: PageProps) {
    ...
    const pricing = getPricingForService('jobs', currency, symbol);
            ...
            <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-50">
                ...
                <div className="mb-16 mt-16 px-4 sm:px-6 lg:px-8">
                    <div className="mx-auto max-w-4xl">
                        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-purple-500 to-blue-600 p-1 shadow-2xl">
                ...
                <div id="pricing" className="mb-16 mt-16 px-4 sm:px-6 lg:px-8">
                    <div className="mb-12 text-center">
                        ...
                        <p className="mx-auto max-w-2xl text-lg text-slate-600">
                            After your free trial, select the perfect plan for your job search needs.
