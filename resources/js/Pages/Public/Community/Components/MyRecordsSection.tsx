...
export default function MyRecordsSection({ member }: MyRecordsSectionProps) {
    ...
    const [healthcareRecords, setHealthcareRecords] = useState<
        HealthcareRecord[]
    >([]);
    ...
    const searchLendingRecords = async () => {
        ...
        try {
            const borrowerName =
                `${visitorInfo.firstName} ${visitorInfo.middleName ? `${visitorInfo.middleName} ` : ''}${visitorInfo.lastName}`.trim();
            const response = await fetch(
                `/m/${member.id}/search-lending?borrower_name=${encodeURIComponent(borrowerName)}`,
            );
            ...
            if (response.ok) {
                ...
                setLendingError(
                    errorData.error || 'Failed to search lending records',
                );
            }
        } catch (error) {
            setLendingError(
                'Network error occurred while searching lending records',
            );
        } finally {
    ...
    const searchHealthcareRecords = async () => {
        ...
        try {
            ...
            const response = await fetch(
                `/m/${member.id}/search-healthcare?${searchParams.toString()}`,
            );
            ...
            if (response.ok) {
                ...
                const errorData = await response.json();
                setHealthcareError(
                    errorData.error || 'Failed to search healthcare records',
                );
            }
        } catch (error) {
            setHealthcareError(
                'Network error occurred while searching healthcare records',
            );
        } finally {
    ...
    const searchMortuaryRecords = async () => {
        ...
        try {
            ...
            const response = await fetch(
                `/m/${member.id}/search-mortuary?${searchParams.toString()}`,
            );
            ...
            if (response.ok) {
                ...
                const errorData = await response.json();
                setMortuaryError(
                    errorData.error || 'Failed to search mortuary records',
                );
            }
        } catch (error) {
            setMortuaryError(
                'Network error occurred while searching mortuary records',
            );
        } finally {
            ...
            <div className="full-width">
                ...
                <div className="mb-8 space-y-4">
                    <div className="flex items-center justify-between">
                        <h4 className="flex items-center text-lg font-semibold text-gray-900 dark:text-gray-100">
                            <svg
                        ...
                        <button
                            ...
                            className="inline-flex items-center rounded-md border border-transparent bg-green-600 px-3 py-2 text-sm font-medium leading-4 text-white hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                        >
                            {isLoadingLending ? (
                                <>
                                    <svg
                            ...
                            <div className="space-y-4">
                                {lendingRecords.map((record) => (
                                    ...
                                    >
                                        ...
                                        {/* Status Badge */}
                                        <div className="border-t border-gray-200 bg-gray-50 px-4 py-2 dark:border-gray-600 dark:bg-gray-700">
                                            <span
                ...
                <div className="mb-8 space-y-4">
                    <div className="flex items-center justify-between">
                        ...
                        <button
                            ...
                            className="inline-flex items-center rounded-md border border-transparent bg-blue-600 px-3 py-2 text-sm font-medium leading-4 text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                        >
                            {isLoadingHealthcare ? (
                                <>
                                    <svg
                                    ...
                                    >
                                        ...
                                        {record.contributions &&
                                            record.contributions.length > 0 && (
                                                <div className="border-b border-gray-200 px-4 py-3 dark:border-gray-700">
                                                    <h6 className="mb-3 flex items-center text-sm font-medium text-gray-900 dark:text-gray-100">
                                                        <svg
                                                        ...
                                                        {record.claims
                                                            ...
                                                            .map((claim) => (
                                                                <div
                                                                    ...
                                                                    className="rounded border-l-4 border-blue-500 bg-gray-50 p-3 dark:bg-gray-700"
                                                                >
                ...
                <div className="mb-8 space-y-4">
                    <div className="flex items-center justify-between">
                        ...
                        <button
                            ...
                            className="inline-flex items-center rounded-md border border-transparent bg-gray-600 px-3 py-2 text-sm font-medium leading-4 text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                        >
                            {isLoadingMortuary ? (
                                <>
                                    <svg
                        ...
                        (mortuaryRecords.length > 0 ? (
                            <div className="space-y-4">
                                {mortuaryRecords.map((record) => (
                                    ...
                                    >
                                        {/* Member Header */}
                                        <div className="border-b border-gray-200 bg-gray-50 px-4 py-3 dark:border-gray-700 dark:bg-gray-900/20">
                                            <div className="flex items-center justify-between">
                                                <div>
                                                    <h5 className="text-sm font-semibold text-gray-900 dark:text-gray-100">
                                                        {record.name}
                                                        ...
                                                        {record.claims
                                                            ...
                                                            .map((claim) => (
                                                                <div
                                                                    ...
                                                                    className="rounded border-l-4 border-gray-500 bg-gray-50 p-3 dark:bg-gray-700"
                                                                >
                                                                    <div className="mb-2 flex items-start justify-between">
                                                                        <div>
                                                                            <p className="text-sm font-medium capitalize text-gray-900 dark:text-gray-100">
