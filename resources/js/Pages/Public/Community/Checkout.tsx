...
export default function Checkout({
    ...
    const updateCartQuantity = (
        ...
        const variant = variantId
            ? product.active_variants?.find((v) => v.id === variantId)
            : undefined;
        ...
        try {
            ...
            const orderData = {
                ...
                order_items: cartItems.map((item) => {
                    ...
                    return {
                        ...
                        price: product
                            ? getEffectivePrice(product, item.variant)
                            : 0,
                ...
                client_identifier:
                    member?.identifier || member?.id?.toString() || '',
            ...
            console.log('Shipping fee calculation:', {
                ...
                itemShippingFees: cartItems.map((item) => ({
                    ...
                    weight:
                        (item.variant?.weight ||
                            products.find((p) => p.id === item.id)?.weight ||
                            0) * item.quantity,
                })),
            });
            ...
            await router.post(
                route('member.public-checkout.store'),
                orderData as any,
                {
                    onSuccess: () => {
    ...
    const getItemShippingFee = (item: CartItem): number => {
        ...
        const itemWeight =
            (item.variant?.weight || product.weight || 0) * item.quantity;
    ...
    const serviceFee = subtotal * 0.1; // 10% of subtotal service fee
    ...
    const steps = [
        ...
        },
        {
            ...
            title: 'Payment',
            icon: CreditCard,
            completed: !!formData.paymentMethod,
        },
                                            ...
                                            <div className="flex flex-col items-end space-y-2">
                                                <div className="flex items-center space-x-1 sm:space-x-2">
                                                    <button
                                                        ...
                                                        className="flex h-6 w-6 items-center justify-center rounded bg-gray-200 text-gray-600 transition-colors hover:bg-gray-300 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-gray-600 dark:text-gray-400 dark:hover:bg-gray-500 sm:h-8 sm:w-8"
                                                    ...
                                                    <span className="min-w-[2rem] text-center text-sm font-medium text-gray-900 dark:text-gray-100 sm:min-w-[3rem] sm:text-lg">
                                                        {item.quantity}
                                                    </span>
                                                    <button
                                                        type="button"
                                                ...
                                                <button
                                                    ...
                                                    className="text-xs text-red-500 transition-colors hover:text-red-700 dark:text-red-400 dark:hover:text-red-300 sm:text-sm"
                                                    disabled={isProcessing}
                                                >
                                                    Remove
                                                </button>
                            ...
                            <div className="space-y-3 border-t border-gray-200 pt-4 dark:border-gray-700">
                                ...
                                {formData.country === 'Philippines' && (
                                    <div className="mt-3 rounded-lg border border-blue-200 bg-blue-50 p-3 dark:border-blue-800 dark:bg-blue-900/20">
                                        ...
                                        {formData.state && (
                                            <div className="mt-3 rounded border border-blue-200 bg-white p-2 dark:border-blue-700 dark:bg-gray-700">
                        ...
                        {cartItems.length === 0 && (
                            <div className="py-8 text-center sm:py-12">
                                ...
                                <p className="mb-6 text-sm text-gray-600 dark:text-gray-400 sm:text-base">
                                    Add some items to your cart to continue with
                                    checkout
                                </p>
                                <button
                                    type="button"
                                    onClick={() => window.history.back()}
                                    className="rounded-lg bg-blue-600 px-4 py-2 font-medium text-white transition-colors hover:bg-blue-700 sm:px-6 sm:py-3"
                                >
                                    Continue Shopping
                                </button>
                            </div>
                            ...
                            <div className="mb-6 rounded-lg border border-green-200 bg-green-50 p-4 dark:border-green-800 dark:bg-green-900/20">
                                <div className="flex items-start space-x-2">
                                    ...
                                    <div className="text-sm text-green-800 dark:text-green-200">
                                        <strong>Information Pre-filled:</strong>{' '}
                                        Your customer information has been
                                        automatically filled from your account
                                        profile. These fields are locked to
                        ...
                        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                            <div className="space-y-2">
                                ...
                                <input
                                    ...
                                    className="w-full cursor-not-allowed rounded-lg border border-gray-300 bg-gray-100 px-4 py-3 text-gray-900 placeholder-gray-500 transition-colors focus:border-blue-500 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-600 dark:text-gray-100 dark:placeholder-gray-400"
                    ...
                    <div className="space-y-6">
                            ...
                            <div className="mb-6 rounded-lg border border-blue-200 bg-blue-50 p-4 dark:border-blue-800 dark:bg-blue-900/20">
                                <div className="flex items-start space-x-2">
                                    ...
                                    <div className="text-sm text-blue-800 dark:text-blue-200">
                                        <strong>Required Fields:</strong> All
                        ...
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                className="w-full rounded-lg border border-gray-300 bg-white px-4 py-3 text-gray-900 placeholder-gray-500 transition-colors focus:border-blue-500 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 dark:placeholder-gray-400"
                            ...
                            <div className="space-y-2">
                                ...
                                {formData.country === 'Philippines' ? (
                                    <select
                                        ...
                                        className="w-full rounded-lg border border-gray-300 bg-white px-4 py-3 text-gray-900 transition-colors focus:border-blue-500 focus:ring-2 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100"
                                        disabled={isProcessing}
                                    >
                                        <option value="">
                                            Select Province
                        ...
                        <div className="rounded-lg border border-blue-200 bg-blue-50 p-4 dark:border-blue-800 dark:bg-blue-900/20">
                                    ...
                                    <div className="flex items-start space-x-2">
                                        ...
                                        <div className="text-sm text-green-800 dark:text-green-200">
                                            <span className="text-xs">
                                                Base shipping rates shown. Final
                                                cost calculated per item based
                            ...
                            <div className="space-y-3">
                                {availableShippingMethods.map((method) => (
                                    <label
                                        key={`${method.id}-${formData.state}-${formData.city}`}
                            ...
                            {/* Shipping Note */}
                            <div className="mt-4 rounded-lg border border-gray-200 bg-gray-50 p-3 dark:border-gray-600 dark:bg-gray-700/50">
                                <div className="flex items-start space-x-2">
                                    <div className="text-sm text-gray-500 dark:text-gray-400">
                                        ℹ️
                                    </div>
                                    <div className="text-xs text-gray-600 dark:text-gray-400">
                                        <strong>Note:</strong> Delivery times
                                        may vary during holidays and peak
                                        seasons.
                                        {formData.country === 'Philippines' &&
                                            ' Base shipping rates shown. Final shipping cost is calculated per item based on weight and distance, then summed for the total.'}
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        {currentStep === 'payment' && (
                            <div className="mb-6 rounded-lg border border-blue-200 bg-blue-50 p-4 dark:border-blue-800 dark:bg-blue-900/20">
                                <div className="flex items-start space-x-2">
                                    ...
                                    <div className="text-sm text-blue-800 dark:text-blue-200">
                                        <strong>Required:</strong> Please select
                                        a payment method before proceeding.
                                    </div>
                                </div>
                            </div>
                        )}
                            ...
                            <div className="flex items-start space-x-3">
                                ...
                                <div>
                                    ...
                                    <p className="mt-1 text-sm text-yellow-700 dark:text-yellow-300">
                                        For bank transfers, please wait for our
                                        confirmation email with payment
                                ...
                                {formData.country === 'Philippines' && (
                                    <div className="mt-3 rounded-lg border border-blue-200 bg-blue-50 p-3 dark:border-blue-800 dark:bg-blue-900/20">
                                        <div className="text-xs text-blue-800 dark:text-blue-200">
                                            📍 Shipping from Central Visayas
                                            (Cebu) to {formData.state}
                                        </div>
                                    </div>
                                )}
                            </div>
