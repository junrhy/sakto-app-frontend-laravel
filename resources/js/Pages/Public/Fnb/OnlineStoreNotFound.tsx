...
export default function OnlineStoreNotFound({ domain }: OnlineStoreNotFoundProps) {
    return (
        <>
                    ...
                    <Card className="max-w-md mx-auto text-center">
                        ...
                        <CardContent className="space-y-4">
                            <p className="text-gray-600 dark:text-gray-400">
                                The online store <strong>{domain}</strong> could not be found or is currently unavailable.
                            </p>
