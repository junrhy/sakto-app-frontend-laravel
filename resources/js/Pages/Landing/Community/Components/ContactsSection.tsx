    ...
    if (contacts.length === 0) {
        return (
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm dark:shadow-gray-900/50 p-8">
                <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-6">Members</h2>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm dark:shadow-gray-900/50 p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredContacts.map((contact) => (
                    <div key={contact.id} className="group bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-xl overflow-hidden hover:shadow-lg dark:hover:shadow-gray-900/70 hover:border-gray-300 dark:hover:border-gray-500 transition-all duration-200">
                        {/* Contact Header */}
                        <div className="p-6">
                            ...
                            <div className="space-y-3">
                                ...
                                {contact.call_number && (
                                    <div className="flex items-center text-sm text-gray-600 dark:text-gray-400">
                                        ...
                                        <span className="truncate">{contact.call_number}</span>
                                    </div>
                                )}
                                ...
                                {contact.sms_number && (
                                    <div className="flex items-center text-sm text-gray-600 dark:text-gray-400">
                                        ...
                                        <span className="truncate">{contact.sms_number}</span>
                                    </div>
                                )}
