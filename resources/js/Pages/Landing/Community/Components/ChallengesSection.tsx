                            ...
                            <div className="flex items-center gap-3">
                                ...
                                >
                                    ...
                                    {challenge.status?.charAt(0).toUpperCase() +
                                        challenge.status?.slice(1) || 'Unknown'}
                                </span>
                                {challenge.end_date && (
                    ...
                    <div className="flex justify-end">
                        {challenge.status === 'active' ? (
                            <Link
                                ...
                                className="inline-flex items-center rounded-lg bg-blue-600 px-6 py-3 font-medium text-white shadow-md transition-all duration-200 hover:bg-blue-700 hover:shadow-lg dark:bg-blue-700 dark:shadow-gray-900/50 dark:hover:bg-blue-600 dark:hover:shadow-gray-900/70"
                            >
                                <svg
                            ...
                            <button
                                className="inline-flex items-center rounded-lg bg-gray-100 px-6 py-3 font-medium text-gray-700 dark:bg-gray-700 dark:text-gray-300"
                                disabled
                            >
                                <svg
                                    className="mr-2 h-4 w-4"
