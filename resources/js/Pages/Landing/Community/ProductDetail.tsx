            ...
            <div className="space-y-6">
              ...
              {product.active_variants && product.active_variants.length > 0 ? (
                <div className="space-y-4">
                  ...
                  <Link
                    href={route('member.checkout', { identifier: member.identifier })}
                    className="w-full inline-flex items-center justify-center px-6 py-3 bg-green-600 dark:bg-green-700 text-white rounded-lg hover:bg-green-700 dark:hover:bg-green-600 transition-colors text-lg font-medium shadow-sm hover:shadow-md"
                  >
