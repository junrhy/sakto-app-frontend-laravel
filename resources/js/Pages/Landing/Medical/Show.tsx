import { faUserMd, faCalendarAlt, faPhone, faEnvelope, faMapMarkerAlt, faClock } from '@fortawesome/free-solid-svg-icons';
                ...
                <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
                    <div className="grid gap-12 lg:grid-cols-3">
                                    ...
                                    <div className="text-center">
                                        ...
                                        <div className="mb-8">
                                            <button
                                                ...
                                                className="inline-flex items-center rounded-xl bg-gradient-to-r from-teal-600 to-emerald-600 px-10 py-4 text-lg font-semibold text-white shadow-lg transition-all duration-300 hover:from-teal-700 hover:to-emerald-700 hover:shadow-xl hover:scale-105"
                                            >
                                                <FontAwesomeIcon
                                                    icon={faCalendarAlt}
                        ...
                        <div className="space-y-6">
                            ...
                            {clinic.user_addresses && clinic.user_addresses.length > 0 && (
                                <div className="rounded-2xl bg-white p-6 shadow-lg">
                                    <div className="mb-4 flex items-center">
                                    ...
                                    <div className="space-y-4">
                                        {clinic.user_addresses.map((address) => (
                    ...
                    {clinicInfo.about && (
                        <div className="mt-16 rounded-3xl bg-gradient-to-r from-teal-50 to-emerald-50 p-8 shadow-lg">
                            <div className="mx-auto max-w-4xl text-center">
                                <h3 className="mb-6 text-2xl font-bold text-gray-900">About {clinic.name}</h3>
