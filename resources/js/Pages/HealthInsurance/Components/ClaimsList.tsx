                ...
                <div className="flex flex-col gap-3 sm:flex-row">
                        ...
                        <Popover>
                            <PopoverTrigger asChild>
                                <Button
                                    variant="outline"
                                    className={cn(
                                        'h-10 w-[240px] justify-start border-slate-300 text-left font-normal text-slate-900 hover:bg-slate-100 dark:border-slate-600 dark:text-slate-200 dark:hover:bg-slate-700',
                                        !startDate &&
                    ...
                    {(startDate || endDate) && (
                        <Button
                            ...
                            className="h-10 text-slate-500 hover:text-slate-900 dark:text-slate-400 dark:hover:text-slate-200"
                        >
                            ...
                            filteredClaims.map((claim) => (
                                ...
                                >
                                    <TableCell className="font-medium text-slate-900 dark:text-slate-100">
                                        {format(
                                            new Date(claim.date_of_service),
                                            'MMM d, yyyy',
                                        )}
                                    </TableCell>
                                    <TableCell className="font-medium text-slate-900 dark:text-slate-100">
