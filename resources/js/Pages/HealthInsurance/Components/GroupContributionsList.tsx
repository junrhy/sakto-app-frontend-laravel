...
export default function GroupContributionsList({ members, contributions = [], appCurrency }: Props) {
    ...
    return (
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        <Input
                            ...
                            className="w-full sm:w-64 bg-white dark:bg-gray-700 border-gray-300 dark:border-gray-600 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400"
                        />
                    </div>
                </div>
            </CardHeader>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
            ...
            <Card className="shadow-lg dark:bg-gray-900 dark:border-gray-700">
                <CardHeader className="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border-b dark:border-gray-700">
                    <CardTitle className="text-lg font-semibold text-gray-800 dark:text-gray-100 flex items-center gap-2">
