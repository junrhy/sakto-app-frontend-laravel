...
export default function UpcomingContributionsList({
                ...
                {totalPages > 1 && (
                    <div className="flex items-center gap-2">
                        <Button
                            ...
                            className="h-8 w-8 border-gray-300 p-0 text-gray-700 hover:bg-gray-100 disabled:opacity-50 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-700"
                        >
    ...
    const ContributionTable = ({
        ...
        return (
            <div className="overflow-hidden rounded-lg bg-white shadow-sm dark:border dark:border-gray-700 dark:bg-gray-900">
                ...
                <div className="overflow-x-auto">
                    <Table>
                        <TableHeader>
                            <TableRow className="bg-gray-50 dark:border-gray-700 dark:bg-gray-800">
    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col gap-4 rounded-lg bg-white p-4 shadow-sm dark:border dark:border-gray-700 dark:bg-gray-900">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex min-w-[400px] items-center gap-4">
                        <Input
                            ...
                            className="w-full dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200 dark:placeholder-gray-400"
                        />
                    </div>
                </div>
                ...
                <div className="flex items-center gap-4">
                    ...
                    >
                        <SelectTrigger className="w-64 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200">
                            <SelectValue />
                        </SelectTrigger>
                        <SelectContent>
                            {groups.map((group) => (
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
                    <div className="rounded-lg bg-gray-50 p-4 dark:border dark:border-gray-700 dark:bg-gray-800">
            ...
            <div className="space-y-8">
                ...
                {monthlyContributions.length === 0 &&
                    quarterlyContributions.length === 0 &&
                    annualContributions.length === 0 && (
                        <div className="rounded-lg bg-gray-50 py-12 text-center text-muted-foreground dark:border dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400">
