            ...
            <div className="flex items-center justify-between px-4 py-3 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50">
                <div className="flex items-center space-x-4 text-sm text-gray-700 dark:text-gray-300">
                    ...
                    <select
                        ...
                        className="border border-gray-300 dark:border-gray-600 rounded px-2 py-1 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 text-sm"
                    >
                ...
                {totalPages > 1 && (
                    <div className="flex items-center gap-2">
                        <Button
                            ...
                            className="h-8 w-8 p-0 border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 disabled:opacity-50"
                        >
                    ...
                    <Table>
                        <TableHeader>
                            <TableRow className="bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <TableHead className="font-semibold dark:text-gray-300">Group</TableHead>
                        ...
                        <TableBody>
                            {currentContributions.map((member) => (
                                <TableRow key={member.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/50 dark:border-gray-700">
                                    ...
                                    <TableCell className="dark:text-gray-300">{member.group || '-'}</TableCell>
                                    <TableCell>
            ...
            <div className="flex flex-col gap-4 p-4 bg-white dark:bg-gray-900 rounded-lg shadow-sm dark:border dark:border-gray-700">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <Select value={selectedGroup} onValueChange={handleGroupChange}>
                        <SelectTrigger className="w-64 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-200">
                            <SelectValue />
                        </SelectTrigger>
                        <SelectContent>
                            {groups.map((group) => (
