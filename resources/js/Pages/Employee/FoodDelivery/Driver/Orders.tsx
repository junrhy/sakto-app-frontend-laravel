...
export default function DriverOrders({ auth, driverId, orders: initialOrders = [], error }: Props) {
    ...
    return (
        <EmployeeLayout
            auth={{ user: auth.user }}
            title="Driver Orders"
            header={<h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100">My Deliveries</h2>}
        >
                ...
                {!driverId ? (
                    ...
                    <Card>
                        <CardHeader className="flex items-center justify-between">
                            ...
                            <Button onClick={() => fetchOrders(driverId)} disabled={loading}>
