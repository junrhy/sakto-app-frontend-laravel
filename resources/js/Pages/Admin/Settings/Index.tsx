...
export default function Index({ auth, settings }: SettingsPageProps) {
    ...
    const registrationSetting = settings.find(
        (s) => s.key === 'registration_enabled',
    );
    const isRegistrationEnabled = registrationSetting?.value === 'true';

    // Maintenance mode settings
    const maintenanceModeSetting = settings.find(
        (s) => s.key === 'maintenance_mode',
    );
    const maintenanceMessageSetting = settings.find(
    ...
    const ipRestrictionSetting = settings.find(
        (s) => s.key === 'ip_restriction_enabled',
    );
        ...
        >
            ...
            <div className="py-12">
                <div className="mx-auto max-w-7xl space-y-6 sm:px-6 lg:px-8">
                    {/* Registration Settings */}
                    <div className="border border-gray-200 bg-white p-4 shadow dark:border-gray-700 dark:bg-gray-800 sm:rounded-lg sm:p-8">
                        <section className="max-w-xl">
                            <header>
                                ...
                                <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                                    Enable or disable user registration on the
                                    site.
                                </p>
                            </header>
                            ...
                            >
                                <div className="flex items-center">
                                    <InputLabel
                                        ...
                                        value="Enable User Registration"
                                ...
                                <InputError
                                    message={registrationForm.errors.enabled}
                                    className="mt-2"
                                />
                    ...
                    <div className="border border-gray-200 bg-white p-4 shadow dark:border-gray-700 dark:bg-gray-800 sm:rounded-lg sm:p-8">
                        <section className="max-w-xl">
                            <header>
                                ...
                                <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                                    Enable or disable site-wide maintenance mode
                            ...
                            >
                                ...
                                <InputError
                                    message={maintenanceForm.errors.enabled}
                                    className="mt-2"
                                />
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 dark:focus:border-indigo-400 dark:focus:ring-indigo-400"
                                        rows={3}
                                        placeholder="Enter maintenance message..."
                                    />
                                    <InputError
                                        message={maintenanceForm.errors.message}
                                        className="mt-2"
                                    />
                                </div>
                    ...
                    <div className="border border-gray-200 bg-white p-4 shadow dark:border-gray-700 dark:bg-gray-800 sm:rounded-lg sm:p-8">
                        <section className="max-w-xl">
                            <header>
                                ...
                                <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
                                    Restrict admin access to specific IP
                                    addresses.
                                </p>
                            </header>

                            <form
                                onSubmit={submitIpRestriction}
                                className="mt-6 space-y-6"
                            >
                                <div className="flex items-center">
                                    <InputLabel
                                        htmlFor="ip_restriction_enabled"
                                        value="Enable IP Restrictions"
                                        className="mr-4 text-gray-700 dark:text-gray-300"
                                    />
                                    <label className="relative inline-flex cursor-pointer items-center">
                                        <input
                                            ...
                                            checked={
                                                ipRestrictionForm.data.enabled
                                            }
                                            onChange={(e) =>
                                                ipRestrictionForm.setData(
                                                    'enabled',
                                                    e.target.checked,
                                                )
                                            }
                                ...
                                <InputError
                                    message={ipRestrictionForm.errors.enabled}
                                    className="mt-2"
                                />
                                ...
                                <div>
                                    ...
                                    <TextInput
                                        ...
                                        type="text"
                                        value={
                                            ipRestrictionForm.data.allowed_ips
                                        }
                                        onChange={(e) =>
                                            ipRestrictionForm.setData(
                                                'allowed_ips',
                                    ...
                                    <InputError
                                        message={
                                            ipRestrictionForm.errors.allowed_ips
                                        }
                                        className="mt-2"
                                    />
                                </div>
                                ...
                                <div className="flex items-center gap-4">
                                    <PrimaryButton
                                        disabled={ipRestrictionForm.processing}
                                    >
                                        Save
                                    </PrimaryButton>
                                </div>
