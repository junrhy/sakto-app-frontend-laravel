...
export default function Edit({ app, subscriptionPlans }: Props) {
    ...
    return (
        <AdminLayout
            ...
            header={<h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Edit App: {app.title}</h2>}
        >
            ...
            <div className="space-y-6">
                ...
                <div className="bg-white dark:bg-gray-800 shadow-sm rounded-lg border border-gray-200 dark:border-gray-700">
                    <div className="p-6">
                        ...
                        <div className="mt-4">
                            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Edit App: {app.title}</h1>
                            <p className="text-gray-600 dark:text-gray-400 mt-1">Update the application module settings</p>
                        </div>
                    </div>
                </div>
