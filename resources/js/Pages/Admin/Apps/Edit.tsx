...
export default function Edit({ app, subscriptionPlans }: Props) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        includedInPlans: app.includedInPlans || [],
        bgColor: app.bgColor,
    ...
    const addCategory = () => {
        if (
            ...
            !data.categories.includes(data.newCategory.trim())
        ) {
            setData('categories', [
                ...data.categories,
                data.newCategory.trim(),
    ...
    const addPlan = () => {
        if (
            data.newPlan.trim() &&
            !data.includedInPlans.includes(data.newPlan.trim())
        ) {
            setData('includedInPlans', [
                ...data.includedInPlans,
                data.newPlan.trim(),
            ]);
            setData('newPlan', '');
    ...
    const removePlan = (plan: string) => {
        setData(
            'includedInPlans',
            data.includedInPlans.filter((p) => p !== plan),
        );
    };
    ...
    const filteredIcons = allIconNames.filter((iconName) => {
        ...
        const matchesCategory =
            ...
            Object.entries(iconCategories).some(
                ([category, icons]) =>
                    category === selectedIconCategory &&
                    ...
                    <div className="p-6">
                        ...
                        <div className="mt-4">
                            ...
                            <p className="mt-1 text-gray-600 dark:text-gray-400">
                                Update the application module settings
                            </p>
                        </div>
                    </div>
                </div>
                            ...
                            >
                                <div className="border-b border-gray-200 dark:border-gray-700">
                                    <TabsList className="h-auto w-full justify-start bg-transparent p-0">
                                        <TabsTrigger
                                            value="basic"
                                            className="px-6 py-4 text-sm font-medium data-[state=active]:border-b-2 data-[state=active]:border-blue-600 data-[state=active]:bg-gray-50 data-[state=active]:text-blue-600 dark:data-[state=active]:bg-gray-700/50 dark:data-[state=active]:text-blue-400"
                                        >
                                            Basic Info
                                        </TabsTrigger>
                                        <TabsTrigger
                                ...
                                >
                                    <div>
                                        ...
                                        <p className="mb-6 text-gray-600 dark:text-gray-400">
                                            Configure the basic details of your
                                            app
                                        </p>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            >
                                                <SelectTrigger
                                                    className={`border border-gray-300 dark:border-gray-600 ${errors.pricingType ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : 'focus:border-blue-500 focus:ring-blue-500'}`}
                                                >
                                                    <SelectValue />
                                                </SelectTrigger>
                                                <SelectContent>
                                ...
                                >
                                    <div>
                                        ...
                                        <p className="mb-6 text-gray-600 dark:text-gray-400">
                                            Add categories to help users find
                                            this app
                                        </p>
                                    </div>
                                                ...
                                                {data.categories.map(
                                                    (category) => (
                                                        <Badge
                                                            key={category}
                                                            variant="secondary"
                                                            className="flex items-center gap-1 bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-200"
                                                        >
                                                            {category}
                                                            <button
                                                                type="button"
                                                ...
                                                {PREDEFINED_CATEGORIES.map(
                                                    (category) => (
                                                        <button
                                                            ...
                                                            disabled={data.categories.includes(
                                                                category,
                                                            )}
                                                            className="rounded-md bg-gray-100 px-3 py-1 text-xs transition-colors hover:bg-gray-200 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-gray-700 dark:hover:bg-gray-600"
                                                        >
                                                            {category}
                                                        </button>
                                                    ),
                                ...
                                >
                                    <div>
                                        ...
                                        <p className="mb-6 text-gray-600 dark:text-gray-400">
                                            Select which subscription plans
                                            include this app
                                        </p>
                                    </div>
                                                                ...
                                                                {plans.map(
                                                                    (plan) => (
                                                                        <button
                                                                            ...
                                                                            disabled={data.includedInPlans.includes(
                                                                                plan.slug,
                                                                            )}
                                                                            className="rounded-md bg-gray-100 px-3 py-1 text-xs transition-colors hover:bg-gray-200 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-gray-700 dark:hover:bg-gray-600"
                                ...
                                >
                                    <div>
                                        ...
                                        <p className="mb-6 text-gray-600 dark:text-gray-400">
                                            Choose the background color for this
                                            app
                                        </p>
                                    </div>
                                            ...
                                            <div className="space-y-3">
                                                ...
                                                {data.icon && (
                                                    <div className="flex items-center gap-2 rounded-lg bg-gray-50 p-2 dark:bg-gray-800">
                                                        <div className="flex h-8 w-8 items-center justify-center rounded-lg border border-gray-200 bg-white dark:border-gray-600 dark:bg-gray-700">
                                                            {React.createElement(
                                                                getIconByName(
                                                                    data.icon,
                                                                ),
                                                ...
                                                {/* Icon Grid */}
                                                <div className="grid max-h-60 grid-cols-6 gap-2 overflow-y-auto rounded-lg border border-gray-200 p-3 dark:border-gray-700">
                                                    ...
                                                    0 ? (
                                                        ...
                                                        <div className="col-span-6 py-8 text-center text-gray-500 dark:text-gray-400">
                                                            No icons found
                                                            matching your
                                                            criteria
                                                        </div>
                    ...
                    <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                        <div className="flex justify-end gap-4">
                            ...
                            <Button
                                type="submit"
                                disabled={processing}
                                className="bg-blue-600 px-6 text-white hover:bg-blue-700 dark:bg-blue-600 dark:text-white dark:hover:bg-blue-700"
                            >
                                {processing ? 'Updating...' : 'Update App'}
                            </Button>
                        </div>
                    </div>
                </form>
