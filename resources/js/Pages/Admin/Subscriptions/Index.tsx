                            ...
                            <div className="mb-4">
                                <div className="flex items-center space-x-4">
                                    ...
                                    <select
                                        ...
                                        className="block w-64 rounded-md border border-gray-300 px-3 py-2 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100"
                                    >
