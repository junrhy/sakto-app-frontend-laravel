...
export default function GroupContributionsList({
    ...
    return (
        <div className="space-y-6">
            <Card className="shadow-lg dark:border-gray-800 dark:bg-gray-950">
                <CardHeader className="border-b bg-gray-50 dark:border-gray-800 dark:bg-gray-900/50">
                    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <div className="flex items-center gap-2">
                            <Input
                                ...
                                className="w-full border-gray-300 bg-white text-gray-900 placeholder-gray-500 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-100 dark:placeholder-gray-400 sm:w-64"
                            />
                        </div>
                    </div>
                </CardHeader>
                <CardContent className="p-6 dark:bg-gray-950">
                    <Table>
                        <TableHeader>
                            <TableRow className="bg-gray-50 hover:bg-transparent dark:border-gray-800 dark:bg-gray-900/50">
                                <TableHead className="font-semibold text-gray-700 dark:text-gray-200">
                                    Group Name
                                </TableHead>
                                <TableHead className="text-center font-semibold text-gray-700 dark:text-gray-200">
                                    Members
                                </TableHead>
                        ...
                        <TableBody>
                            ...
                            <TableRow className="bg-gray-50 hover:bg-gray-100 dark:border-gray-800 dark:bg-gray-900 dark:hover:bg-gray-800">
            ...
            <div className="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-2">
                ...
                <Card className="shadow-lg dark:border-gray-800 dark:bg-gray-950">
                    <CardHeader className="border-b bg-gradient-to-r from-blue-50 to-indigo-50 dark:border-gray-800 dark:from-blue-900/20 dark:to-indigo-900/20">
                ...
                <Card className="shadow-lg dark:border-gray-800 dark:bg-gray-950">
                    <CardHeader className="border-b bg-gradient-to-r from-green-50 to-emerald-50 dark:border-gray-800 dark:from-green-900/20 dark:to-emerald-900/20">
                        <CardTitle className="flex items-center gap-2 text-lg font-semibold text-gray-800 dark:text-gray-100">
