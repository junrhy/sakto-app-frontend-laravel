...
export default function SubmitClaimDialog({ isOpen, onClose, onClaimSubmitted, members, appCurrency }: Props) {
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        ...
                        <Select value={formData.claim_type} onValueChange={value => handleInputChange('claim_type', value)}>
                            ...
                            <SelectContent>
                                ...
                                <SelectItem value="burial_plot">Burial Plot</SelectItem>
                    ...
                    <div>
                        ...
                        <Input
                            ...
                            onChange={e => handleInputChange('relationship_to_member', e.target.value)}
                            required
                        />
                    </div>
                    <div>
