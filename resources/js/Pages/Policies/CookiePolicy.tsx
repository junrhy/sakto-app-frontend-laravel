                            ...
                            <div id="cookie-content" className="space-y-6">
                                ...
                                <section>
                                    ...
                                    <ul className="list-disc ml-6 mt-2">
                                        ...
                                        <li>Security - We use cookies as an element of the security measures used to protect user accounts and our website in general</li>
                                ...
                                <section>
                                    ...
                                    <p>Most browsers allow you to refuse to accept cookies and to delete them. The methods for doing so vary from browser to browser, and from version to version. You can however obtain up-to-date information about blocking and deleting cookies via these links:</p>
                                    <ul className="list-disc ml-6 mt-2">
                                        ...
                                        <li>Edge: microsoft.com/edge/support/privacy</li>
                                    </ul>
                                </section>

                                <section>
                                    <h2 className="text-xl font-semibold mb-3">5. Impact of Blocking Cookies</h2>
                                ...
                                <section>
                                    <h2 className="text-xl font-semibold mb-3">6. Changes to Cookie Policy</h2>
