                        ...
                        <div className="p-6 text-gray-900">
                            <div className="mb-8 flex items-center justify-between">
                                ...
                                <DownloadPdfButton
                                    ...
                                    fileName={`${hostname}-terms-and-conditions`}
                                />
                            </div>
                            ...
                            <div id="terms-content" className="space-y-6">
                                ...
                                <section>
                                    ...
                                    <p>
                                        ...
                                        access the materials within {hostname}{' '}
                                        App for personal, non-commercial use.
                                    ...
                                    <ul className="ml-6 mt-2 list-disc">
                                        ...
                                        <li>
                                            ...
                                            engineer any software contained in{' '}
                                            {hostname} App
                                        </li>
                                        <li>
                                ...
                                <section>
                                    ...
                                    <p>
                                        To access certain features of {hostname}{' '}
                                        App, you may be required to create an
                                ...
                                <section>
                                    ...
                                    <p>
                                        ...
                                        the service with or without notice. We
                                        shall not be liable to you or any third
                                        party for any modification, suspension,
                                ...
                                <section>
                                    ...
                                    <p>
                                        ...
                                        laws of the Philippines and you
                                        irrevocably submit to the exclusive
                                        jurisdiction of the courts in that
                                        location.
                                    </p>
                                </section>
                                ...
                                <section>
                                    ...
                                    <p>
                                        ...
                                        terms at any time. We do so by posting
                                        and drawing attention to the updated
                                        terms on the site. Your decision to
                                        continue to visit and make use of the
                                        site after such changes have been made
                                        constitutes your formal acceptance of
