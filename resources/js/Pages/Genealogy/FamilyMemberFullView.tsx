...
export default function FamilyMemberFullView({
    familyMembers,
    clientIdentifier,
}: FamilyMemberFullViewProps) {
    const { url } = usePage();
        ...
        if (rootMember) {
            ...
            const processDescendants = (member: FamilyMember) => {
                const children = member.relationships
                    ...
                    .map((rel) => getMemberById(rel.to_member_id))
                    .filter(
                        (child): child is FamilyMember => child !== undefined,
                    );
    ...
    const parentChildStructure = useMemo(() => {
        ...
        const membersToProcess = rootMember ? [rootMember] : familyMembers;

        membersToProcess.forEach((member) => {
            const isParent = member.relationships.some(
    ...
    const exportToCSV = (onlyLiving: boolean = false) => {
        ...
        link.setAttribute(
            'download',
            `family_members${onlyLiving ? '_living' : ''}.csv`,
        );
    ...
    const exportMenuContent = (
        <div
            className={`absolute right-0 z-50 mt-2 w-48 rounded-lg py-1 shadow-lg ${
    ...
    return (
        ...
        >
            ...
            {/* Header */}
            <div
                className={`fixed left-0 right-0 top-0 z-50 ${isDarkMode ? 'bg-gray-800' : 'bg-white'} shadow-lg`}
            >
                            ...
                            <div className="flex items-center space-x-2">
                                ...
                                <div className="flex items-center space-x-1">
                                    <button
                                        ...
                                        className={`rounded-lg p-2 transition-colors ${
                                            isDarkMode
                                                ? `${viewMode === 'list' ? 'bg-blue-600' : 'bg-gray-700'} text-gray-200 hover:bg-gray-600`
                                                : `${viewMode === 'list' ? 'bg-blue-100' : 'bg-gray-100'} text-gray-700 hover:bg-gray-200`
                                        }`}
                                        title="List View"
                                    >
                                        <FaList />
                                    ...
                                    <button
                                        ...
                                        className={`rounded-lg p-2 transition-colors ${
                                            isDarkMode
                                                ? `${viewMode === 'grid' ? 'bg-blue-600' : 'bg-gray-700'} text-gray-200 hover:bg-gray-600`
                                                : `${viewMode === 'grid' ? 'bg-blue-100' : 'bg-gray-100'} text-gray-700 hover:bg-gray-200`
                                        }`}
                                        title="Grid View"
                                    >
                                        <FaThLarge />
                                    ...
                                    <button
                                        ...
                                        className={`rounded-lg p-2 transition-colors ${
                                            isDarkMode
                                                ? `${viewMode === 'qr' ? 'bg-blue-600' : 'bg-gray-700'} text-gray-200 hover:bg-gray-600`
                                                : `${viewMode === 'qr' ? 'bg-blue-100' : 'bg-gray-100'} text-gray-700 hover:bg-gray-200`
                                        }`}
                                        title="QR Code View"
                                    >
                                        <FaQrcode />
            ...
            {/* Sidebar */}
            <div
                className={`fixed bottom-0 left-0 top-16 w-64 overflow-y-auto transition-colors duration-200 ${isDarkMode ? 'bg-gray-800' : 'bg-white'} hidden shadow-lg lg:block`}
            >
                <div className="p-4">
                    {/* Root Selector */}
                    <div className="mb-6">
                        <label
                            className={`mb-2 block text-sm font-medium ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}
                        >
                            Root Member
                        </label>
                        <div className="relative">
                            ...
                            {isRootSelectorOpen && (
                                ...
                                >
                                    {/* Search input */}
                                    <div className="${isDarkMode ? 'border-gray-600' : 'border-gray-200'} border-b p-2">
                                        <div className="relative">
                                            <FaSearch
                                            ...
                                            .filter(
                                                (member) =>
                                                    ...
                                                    `${member.first_name} ${member.last_name}`
                                                        .toLowerCase()
                                                        .includes(
                                                            rootSelectorSearch.toLowerCase(),
                                                        ),
                                            )
                                            .sort((a, b) =>
                                                `${a.first_name} ${a.last_name}`.localeCompare(
                        ...
                        {rootMember ? (
                            <div className="space-y-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <ul
                                        className={`space-y-1 pl-4 ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}
                                    >
                                        {rootMember.relationships
                                            .filter(
                                                (rel) =>
                                        ...
                                        {rootMember.relationships.filter(
                                            (rel) =>
                                                rel.relationship_type ===
                                                'child',
                                        ).length === 0 && (
            ...
            <div className="px-4 pb-8 pt-28 lg:pl-72 lg:pt-20">
                {/* Stats Section */}
                <div className="mb-6 overflow-x-auto">
                    <div className="min-w-max">
                        <div
                            className={`grid grid-cols-9 gap-2 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}
                        >
                            {/* Total, Living, Deceased Stats */}
                            <div
                                className={`rounded-lg border border-gray-200 p-2 ${isDarkMode ? 'bg-gray-800/80 hover:bg-gray-800' : 'bg-white hover:bg-gray-50'} min-w-[90px] shadow-lg transition-colors`}
                            >
                                <div
                            ...
                            >
                                <div
                                    className={`text-xs ${isDarkMode ? 'text-pink-300' : 'text-pink-600'}`}
                                >
                                    Female
                                </div>
                                <div className="text-lg font-semibold">
                            ...
                            >
                                <div
                                    className={`text-xs ${isDarkMode ? 'text-yellow-300' : 'text-yellow-600'}`}
                                >
                                    Age 1-6
                                </div>
                                <div className="text-lg font-semibold">
                            ...
                            >
                                <div
                                    className={`text-xs ${isDarkMode ? 'text-orange-300' : 'text-orange-600'}`}
                                >
                                    Age 7-17
                                </div>
                                <div className="text-lg font-semibold">
                            ...
                            >
                                <div
                                    className={`text-xs ${isDarkMode ? 'text-teal-300' : 'text-teal-600'}`}
                                >
                                    18-59
                                </div>
                                <div className="text-lg font-semibold">
                ...
                {viewMode === 'list' ? (
                    ...
                    <div className="space-y-4">
                        {filteredMembers.map((member: FamilyMember) => (
                            <div
                                key={member.id}
                                className={`flex items-center rounded-lg p-4 shadow-lg transition-all duration-200 ${
                            ...
                            >
                                {/* QR Code */}
                                <div
                                    className={`mr-6 p-3 ${isDarkMode ? 'bg-gray-700' : 'bg-gray-50'} flex-shrink-0 rounded-lg shadow-inner`}
                                >
                                    <QRCodeSVG
                                ...
                                <div className="min-w-0 flex-grow">
                                    ...
                                    >
                                        <span className="mr-4 inline-block">
                                            <span
                                                className={`font-medium ${isDarkMode ? 'text-indigo-300' : 'text-indigo-600'}`}
                                            >
                                                Birth Date:
                                            </span>{' '}
                                            {new Date(
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5">
                        {filteredMembers.map((member: FamilyMember) => (
                            <div
                                key={member.id}
                                className={`cursor-pointer overflow-hidden rounded-lg border border-gray-200 shadow-lg transition-all duration-200 ${
                                    selectedMember?.id === member.id
                                        ? isDarkMode
                                            ? 'bg-indigo-900/30 ring-2 ring-indigo-500'
                                            : 'bg-indigo-50 ring-2 ring-indigo-300'
                            ...
                            >
                                {/* Member Photo */}
                                <div
                                    className={`aspect-square w-full lg:aspect-[4/3] ${isDarkMode ? 'bg-gray-700' : 'bg-gray-100'}`}
                                >
                                    {member.photo ? (
                                        <img
                                            src={member.photo}
                                        ...
                                        <div className="flex h-full w-full items-center justify-center">
                                            <span
                                                className={`text-4xl font-semibold lg:text-3xl ${
                                                    isDarkMode
                                                        ? 'text-gray-500'
                                                        : 'text-gray-400'
                                                }`}
                                ...
                                <div className="p-4 lg:p-3">
                                    <h3
                                        className={`text-lg font-semibold lg:text-base ${isDarkMode ? 'text-white' : 'text-gray-900'}`}
                                    >
                                        {member.first_name} {member.last_name}
                                    </h3>
                                    <div className="mb-3 mt-2 flex items-center">
                                        <button
                                            ...
                                            className={`mr-2 rounded-lg p-2 text-sm transition-colors ${
                                                isDarkMode
                                                    ? 'bg-indigo-500/20 text-indigo-300 hover:bg-indigo-500/30'
                                                    : 'bg-indigo-50 text-indigo-600 hover:bg-indigo-100'
                                            }`}
                                    ...
                                    <div
                                        className={`space-y-2 text-sm lg:space-y-1 ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}
                                    >
                                        <p>
                                            <span
                                                className={`font-medium ${isDarkMode ? 'text-indigo-300' : 'text-indigo-600'}`}
                                                        ...
                                                        (
                                                            ...
                                                            return relatedMember ? (
                                                                ...
                                                                >
                                                                    ...
                                                                    :{' '}
                                                                    {
                                                                        relatedMember.first_name
                                                                    }{' '}
                                                                    {
                                                                        relatedMember.last_name
                                                                    }
                                                                </li>
                                                            ) : null;
                                                        },
                    ...
                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5">
                        {filteredMembers.map((member: FamilyMember) => (
                            <div
                                key={member.id}
                                className={`mx-auto w-full max-w-[280px] rounded-lg p-4 shadow-lg ${
                                    isDarkMode ? 'bg-gray-800' : 'bg-white'
                                }`}
                            >
                                <div
                                    className={`mb-4 p-3 ${isDarkMode ? 'bg-white' : 'bg-gray-100'} flex items-center justify-center rounded-lg`}
                                >
                                    <QRCodeSVG
                                        value={`${window.location.origin}/genealogy/${clientIdentifier}/member/${member.id}`}
                                        size={200}
            ...
            {showQRCode !== null && (
                ...
                >
                    <div
                        className={`rounded-lg p-6 ${isDarkMode ? 'bg-gray-800' : 'bg-white'} shadow-xl`}
                    ...
                    >
                        ...
                        <div
                            className={`p-4 ${isDarkMode ? 'bg-white' : 'bg-gray-100'} rounded-lg`}
                        >
                            <QRCodeSVG
                        ...
                        <button
                            className={`mt-4 w-full rounded-lg py-2 text-center ${
                                isDarkMode
