...
export default function WelcomeShop({ auth }: PageProps) {
    ...
    return (
        <>
            <Head title="Welcome - Online Shopping" />
                            ...
                            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                                <div className="sm:text-center lg:text-left">
                                    <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                                        ...
                                        <span className="block text-indigo-600">Online Marketplace</span>
                                    </h1>
                                    <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                                        Shop from local sellers or start your own online store. Buy and sell with confidence in our secure marketplace.
                                    </p>
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="lg:text-center">
                            ...
                            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
                                Our platform provides all the tools and features needed for a successful online shopping experience.
                            </p>
                        </div>
                            ...
                            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                                ...
                                <div className="relative">
                                    ...
                                    <p className="mt-2 ml-16 text-base text-gray-500">
                                        Access a wide range of products from local and international sellers.
                                    </p>
                                </div>
                                ...
                                <div className="relative">
                                    ...
                                    <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Verified Sellers</p>
                                    <p className="mt-2 ml-16 text-base text-gray-500">
                                        All sellers are verified to ensure a safe shopping experience.
                                    </p>
                                </div>
                                ...
                                <div className="relative">
                                    ...
                                    <p className="mt-2 ml-16 text-base text-gray-500">
                                        Simple tools for managing your store and inventory.
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
                                ...
                                <div className="relative bg-white p-6 rounded-lg shadow-lg">
                                    <div className="text-center">
                                        ...
                                        <h3 className="text-lg font-medium text-gray-900">Shop as a Buyer</h3>
                                ...
                                <div className="relative bg-white p-6 rounded-lg shadow-lg">
                                    <div className="text-center">
                                        ...
                                        <h3 className="text-lg font-medium text-gray-900">Sell as a Seller</h3>
                                        <p className="mt-2 text-base text-gray-500">
                                            Set up your online store, manage inventory, and reach customers worldwide.
                                        </p>
                                        <div className="mt-4">
                                            <Link
                                                href={route('register')}
                ...
                <div className="bg-indigo-700">
                    <div className="max-w-2xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
                        <h2 className="text-3xl font-extrabold text-white sm:text-4xl">
                            ...
                            <span className="block">Join our marketplace today.</span>
                        </h2>
                        <p className="mt-6 text-lg leading-6 text-indigo-200">
                            Whether you're looking to buy or sell, our platform provides everything you need for a successful online shopping experience.
                        </p>
                        <Link
                            href={route('register')}
                    ...
                    <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
                        ...
                        <div className="mt-8 md:mt-0 md:order-1">
                            <p className="text-center text-base text-gray-400">
                                &copy; 2024 Online Marketplace. All rights reserved.
                            </p>
                        </div>
                    </div>
                </footer>
