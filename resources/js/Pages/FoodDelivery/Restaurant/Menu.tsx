...
import { FoodDeliveryMenuItem, FoodDeliveryMenuCategory, MenuItemFormData } from '../types';
...
export default function RestaurantMenu({ auth, restaurantId, menuItems: initialMenuItems, categories: initialCategories }: Props) {
