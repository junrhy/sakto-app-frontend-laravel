...
import { PackageIcon, SearchIcon, FilterIcon, RefreshCwIcon } from 'lucide-react';
...
export default function RestaurantOrders({ auth, orders: initialOrders, restaurantId }: Props) {
    ...
    const [selectedOrder, setSelectedOrder] = useState<FoodDeliveryOrder | null>(null);
