                                                ...
                                                <div className="space-y-2">
                                                    <div>
                                                        ...
                                                        <p className="text-sm text-gray-500">
                                                            ...
                                                            <span className="ml-1 rounded bg-gray-100 px-1.5 py-0.5 text-xs dark:bg-gray-800">
                                                                BRW
                                                            </span>
                                                        </p>
                                                    </div>
                                                        ...
                                                        return (
                                                            <div className="flex items-center gap-2">
                                                                <div className="flex items-center gap-1.5">
                                                                    ...
                                                                    <span
                                                                        className={`font-medium ${creditScore.color}`}
                                                                    >
                                                                        {
                                                                            creditScore.score
                                                                        }
                                            ...
                                            <TableCell>
                                                <div className="space-y-2">
                                                    ...
                                                    <div className="space-y-1 pt-1">
                                                        ...
                                                        <div className="flex justify-between border-t border-gray-200 pt-1 text-sm font-medium dark:border-gray-700">
                                                            <span>
                                                                Outstanding:
                                                            </span>
                                                    ...
                                                    {showCalculations && (
                                                        <div className="mt-2 space-y-1 rounded bg-gray-50 p-2 text-xs dark:bg-gray-800">
                                                            ...
                                                            <div className="pt-1">
                                                                ...
                                                                <div className="mt-1 whitespace-pre-line text-xs text-gray-600 dark:text-gray-400">
                                                                    {
                                                                        calculateLoanDetails(
                                                                            loan,
                                                                        )
                            ...
                            <div className="grid gap-4 py-4">
                                ...
                                <div className="grid grid-cols-4 items-center gap-4">
                                    ...
                                    <div className="col-span-3 space-y-1">
                                        ...
                                        >
                                            <SelectTrigger
                                                className={`col-span-3 ${validationErrors.status ? 'border-red-500' : ''}`}
                                            >
                ...
                >
                    <DialogContent className="max-w-4xl">
                        ...
                        <DialogFooter>
                            <Button
                                onClick={() =>
                                    setIsBillHistoryDialogOpen(false)
                                }
                            >
                                Close
                            </Button>
                ...
                >
                    <DialogContent>
                        ...
                        <div className="space-y-4 py-4">
                            ...
                            {(() => {
                                const { activeLoans, totalAmount } =
                                    getDeleteWarningInfo(selectedLoans);
                                return (
                                    <div className="space-y-2">
                                        ...
                                        {activeLoans > 0 && (
                                            <p className="text-sm text-red-600">
                                                ⚠️ Warning: You are about to
                                                delete active loans. Make sure
                                                all payments are properly
                ...
                >
                    <DialogContent>
                        ...
                        <div className="grid gap-4 py-4">
                            ...
                            <div className="grid grid-cols-4 items-center gap-4">
                                ...
                                <div className="col-span-3">
                                    <Input
                                        ...
                                        value={billPenalty}
                                        onChange={(e) =>
                                            setBillPenalty(e.target.value)
                                        }
                                        placeholder="0.00"
                                        className="col-span-3"
                                    />
                                    <p className="mt-1 text-sm text-gray-500">
                                        Optional penalty amount to add to the
                                        bill
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="grid grid-cols-4 items-center gap-4">
                                ...
                                <div className="col-span-3">
                                    ...
                                    />
                                    <p className="mt-1 text-sm text-gray-500">
                                        Optional note or description for this
                                        bill
                                    </p>
                                </div>
                            </div>
                        ...
                        <DialogFooter>
                            ...
                            {canEdit && (
                                <Button onClick={confirmCreateBill}>
                                    Create Bill
                                </Button>
                            )}
                        </DialogFooter>
