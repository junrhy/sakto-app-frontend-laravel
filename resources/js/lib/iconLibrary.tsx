...
export const getIconWithFallback = (name: string, fallback: string = 'default'): React.ComponentType<any> => {
    return getIconByName(name) || getIconByName(fallback) || ICON_LIBRARY.default;
};
...
export const getIconsByCategory = () => {
    return {
        ...
        'Technology & Development': [
            'RxRocket', 'RxLayers', 'RxGear', 'RxCode'
        ],
        'People & Communication': [
            'RxPerson', 'RxGroup', 'RxChatBubble', 'RxEnvelopeClosed', 'RxIdCard', 'RxShare1'
        ],
        'Health & Medical': [
            'RxHeart'
        ],
        ...
        'Content & Media': [
            'RxPencil1', 'RxImage', 'RxVideo', 'RxCamera'
        ],
        'Digital & Technology': [
            'RxMobile', 'RxFile', 'RxGlobe'
        ],
        'Games & Entertainment': [
            'RxStar'
        ],
        ...
        'UI Controls': [
            'RxPlus', 'RxMinus', 'RxCheck', 'RxCross2'
        ],
        'Navigation': [
            'RxArrowUp', 'RxArrowDown', 'RxArrowLeft', 'RxArrowRight',
            'RxChevronUp', 'RxChevronDown', 'RxChevronLeft', 'RxChevronRight'
        ],
        'Media Controls': [
            'RxPlay', 'RxStop'
        ],
        'File Operations': [
            'RxDownload', 'RxUpload', 'RxLink1', 'RxExternalLink'
        ],
        'Data Management': [
            'RxBox', 'RxArchive', 'RxTrash', 'RxReload', 'RxUpdate'
        ],
        'Layout & Structure': [
            'RxGrid', 'RxTable', 'RxColumns', 'RxRows', 'RxLayout'
        ],
        'Themes': [
            'RxSun', 'RxMoon'
        ],
        'Utilities': [
            'RxMagnifyingGlass', 'RxAccessibility'
        ]
    };
};
