...
class ResourceController extends CustomerProjectController
{
    public function overview(Request $request, string $project, $ownerIdentifier): Response
    {
        ...
        try {
            ...
            if ($response->successful()) {
                ...
                $resources = $payload['data'] ?? ($payload['pages'] ?? $payload ?? []);
            }

            return Inertia::render('Customer/Resources/Overview', [
                'project' => $project,
            ...
            abort(500, 'Failed to load resources');
        }
    }
